...
class TestAuditor:
                ...
                for test_path in test_paths:
                    ...
                    if test_file:
                        ...
                        if patterns.get("hasattr", 0) > 5:
                            ...
                            is_effective = False
                        if patterns.get("import_only", 0) > 10 and len(test_file.test_functions) < 5:
    ...
    def print_summary(self) -> None:
        ...
        avg_coverage = (
            sum(r.coverage_percent for r in self.coverage_data.values()) 
            / len(self.coverage_data) if self.coverage_data else 0
        )
...
def main():
    ...
    parser.add_argument("--output", "-o", 
                        default="reports/test_audit.csv",
