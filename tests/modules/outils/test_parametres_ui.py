...
class TestParametresUI:
    ...
    @patch("src.modules.outils.parametres.render_about")
    @patch("src.modules.outils.parametres.render_budget_config")
    @patch("src.modules.outils.parametres.render_display_config")
    @patch("src.modules.outils.parametres.render_cache_config")
    @patch("src.modules.outils.parametres.render_database_config")
    @patch("src.modules.outils.parametres.render_ia_config")
    @patch("src.modules.outils.parametres.render_foyer_config")
    ...
    def test_render_foyer_config(self, mock_st, mock_etat) -> None:
        """Test config foyer."""
        from src.modules.outils.parametres import render_foyer_config
    ...
    @patch("src.modules.outils.parametres.get_settings")
    @patch("src.modules.outils.parametres.st")
    def test_render_ia_config(self, mock_st, mock_settings) -> None:
        """Test config IA."""
        from src.modules.outils.parametres import render_ia_config
    ...
    @patch("src.modules.outils.parametres.get_db_info")
    @patch("src.modules.outils.parametres.health_check")
    @patch("src.modules.outils.parametres.st")
    def test_render_database_config(self, mock_st, mock_health, mock_info) -> None:
        """Test config database."""
        from src.modules.outils.parametres import render_database_config
    ...
    @patch("src.modules.outils.parametres.Cache")
    @patch("src.modules.outils.parametres.SemanticCache")
    @patch("src.modules.outils.parametres.st")
    def test_render_cache_config(self, mock_st, mock_sem, mock_cache) -> None:
        """Test config cache."""
        from src.modules.outils.parametres import render_cache_config
    ...
    def test_render_budget_config_exists(self) -> None:
        """Test that render_budget_config exists."""
        from src.modules.outils.parametres import render_budget_config

        assert callable(render_budget_config)

    @patch("src.modules.outils.parametres.st")
    def test_render_about(self, mock_st) -> None:
        """Test page a propos."""
        from src.modules.outils.parametres import render_about
...
class TestImports:
    ...
    def test_import_render_foyer_config(self) -> None:
        """Test import render_foyer_config."""
        from src.modules.outils.parametres import render_foyer_config

        assert callable(render_foyer_config)

    def test_import_render_ia_config(self) -> None:
        """Test import render_ia_config."""
        from src.modules.outils.parametres import render_ia_config

        assert callable(render_ia_config)

    def test_import_render_database_config(self) -> None:
        """Test import render_database_config."""
        from src.modules.outils.parametres import render_database_config

        assert callable(render_database_config)

    def test_import_render_cache_config(self) -> None:
        """Test import render_cache_config."""
        from src.modules.outils.parametres import render_cache_config

        assert callable(render_cache_config)

    def test_import_render_display_config(self) -> None:
        """Test import render_display_config."""
        from src.modules.outils.parametres import render_display_config

        assert callable(render_display_config)

    def test_import_render_budget_config(self) -> None:
        """Test import render_budget_config."""
        from src.modules.outils.parametres import render_budget_config

        assert callable(render_budget_config)

    def test_import_render_about(self) -> None:
        """Test import render_about."""
        from src.modules.outils.parametres import render_about
