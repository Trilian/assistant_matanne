...
def mock_st():
    ...
    with patch("src.modules.outils.notifications_push.st") as mock:
        mock.session_state = {}
...
class TestImports:
    ...
    def test_import_module(self):
        ...
        from src.modules.outils import notifications_push

        assert notifications_push is not None

    def test_import_app(self):
        """Test que la fonction app() est importable."""
        from src.modules.outils.notifications_push import app

        assert callable(app)

    def test_import_constants(self):
        """Test que les constantes sont importables."""
        from src.modules.outils.notifications_push import HELP_NTFY

        assert "ntfy.sh" in HELP_NTFY

    def test_import_helpers(self):
        """Test que les helpers sont importables."""
        from src.modules.outils.notifications_push import (
            charger_config,
            sauvegarder_config,
        )
...
class TestHelpers:
    ...
    def test_charger_config_cree_config_defaut(self, mock_st):
        ...
        from src.modules.outils.notifications_push import charger_config
    ...
    def test_sauvegarder_config(self, mock_st, mock_config):
        ...
        from src.modules.outils.notifications_push import sauvegarder_config
...
class TestRenderConfiguration:
    ...
    def test_render_configuration_affiche_formulaire(
        ...
        from src.modules.outils.notifications_push import render_configuration
    ...
    @patch("src.modules.outils.notifications_push.sauvegarder_config")
    @patch("src.modules.outils.notifications_push.charger_config")
...
class TestRenderAbonnement:
    ...
    def test_render_abonnement_affiche_qr_code(
        ...
        from src.modules.outils.notifications_push import render_abonnement
...
class TestRenderTachesRetard:
    ...
    def test_render_taches_retard_sans_taches(
        ...
        from src.modules.outils.notifications_push import render_taches_retard
...
class TestRenderAide:
    ...
    def test_render_aide_affiche_aide(self, mock_st):
        ...
        from src.modules.outils.notifications_push import render_aide
...
class TestApp:
    ...
    @patch("src.modules.outils.notifications_push.render_aide")
    @patch("src.modules.outils.notifications_push.render_test")
    @patch("src.modules.outils.notifications_push.render_taches_retard")
    @patch("src.modules.outils.notifications_push.render_configuration")
    @patch("src.modules.outils.notifications_push.render_abonnement")
