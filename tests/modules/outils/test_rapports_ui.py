...
class TestRapportsUI:
    ...
    @patch("src.modules.outils.rapports.render_historique")
    @patch("src.modules.outils.rapports.render_analyse_gaspillage")
    @patch("src.modules.outils.rapports.render_rapport_budget")
    @patch("src.modules.outils.rapports.render_rapport_stocks")
    @patch("src.modules.outils.rapports.st")
    def test_app_basic(self, mock_st, *mocks) -> None:
        """Test du rendu basique de app()."""
        from src.modules.outils.rapports import app
    ...
    @patch("src.modules.outils.rapports.get_rapports_service")
    @patch("src.modules.outils.rapports.st")
    def test_render_rapport_stocks(self, mock_st, mock_srv) -> None:
        """Test rapport stocks."""
        from src.modules.outils.rapports import render_rapport_stocks
    ...
    def test_render_rapport_budget(self, mock_st, mock_srv) -> None:
        """Test rapport budget."""
        from src.modules.outils.rapports import render_rapport_budget
    ...
    def test_render_analyse_gaspillage(self, mock_st, mock_srv) -> None:
        ...
        from src.modules.outils.rapports import render_analyse_gaspillage
    ...
    def test_render_historique_empty(self, mock_st, mock_srv) -> None:
        ...
        from src.modules.outils.rapports import render_historique
...
class TestGetRapportsService:
    ...
    @patch("src.modules.outils.rapports.RapportsPDFService")
    @patch("src.modules.outils.rapports.st")
    def test_creates_service(self, mock_st, mock_cls) -> None:
        """Test creation service."""
        from src.modules.outils.rapports import get_rapports_service
...
class TestImports:
    ...
    def test_import_render_rapport_stocks(self) -> None:
        """Test import render_rapport_stocks."""
        from src.modules.outils.rapports import render_rapport_stocks

        assert callable(render_rapport_stocks)

    def test_import_render_rapport_budget(self) -> None:
        """Test import render_rapport_budget."""
        from src.modules.outils.rapports import render_rapport_budget

        assert callable(render_rapport_budget)

    def test_import_render_analyse_gaspillage(self) -> None:
        """Test import render_analyse_gaspillage."""
        from src.modules.outils.rapports import render_analyse_gaspillage

        assert callable(render_analyse_gaspillage)

    def test_import_render_historique(self) -> None:
        """Test import render_historique."""
        from src.modules.outils.rapports import render_historique
