...
class TestRapportsUI:
    ...
    @patch("src.modules.utilitaires.rapports.render_historique")
    @patch("src.modules.utilitaires.rapports.render_analyse_gaspillage")
    @patch("src.modules.utilitaires.rapports.render_rapport_budget")
    @patch("src.modules.utilitaires.rapports.render_rapport_stocks")
    ...
    def test_render_rapport_stocks(self, mock_st, mock_srv) -> None:
        """Test rapport stocks."""
        from src.modules.utilitaires.rapports import render_rapport_stocks
    ...
    def test_render_rapport_budget(self, mock_st, mock_srv) -> None:
        """Test rapport budget."""
        from src.modules.utilitaires.rapports import render_rapport_budget
    ...
    def test_render_analyse_gaspillage(self, mock_st, mock_srv) -> None:
        ...
        from src.modules.utilitaires.rapports import render_analyse_gaspillage
    ...
    def test_render_historique_empty(self, mock_st, mock_srv) -> None:
        ...
        from src.modules.utilitaires.rapports import render_historique
...
class TestGetRapportsService:
    ...
    @patch("src.modules.utilitaires.rapports.RapportsPDFService")
    @patch("src.modules.utilitaires.rapports.st")
