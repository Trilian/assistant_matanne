...
class TestRenderNavigationSemaine:
    """Tests pour la fonction render_navigation_semaine."""

    @patch("src.modules.planning.calendrier_unifie.components.st")
    def test_render_navigation_basic(self, mock_st: MagicMock) -> None:
        """Test du rendu basique de la navigation."""
        from src.modules.planning.calendrier_unifie.components import render_navigation_semaine
...
class TestRenderJourCalendrier:
    """Tests pour la fonction render_jour_calendrier."""

    @patch("src.modules.planning.calendrier_unifie.components.st")
    def test_render_jour_empty(self, mock_st: MagicMock) -> None:
        """Test du rendu d un jour sans evenements."""
        from src.modules.planning.calendrier_unifie.components import render_jour_calendrier
...
class TestRenderVueSemaineGrille:
    """Tests pour la fonction render_vue_semaine_grille."""

    @patch("src.modules.planning.calendrier_unifie.components.st")
    def test_render_grille_empty_week(self, mock_st: MagicMock) -> None:
        """Test du rendu d une semaine vide."""
        from src.modules.planning.calendrier_unifie.components import render_vue_semaine_grille
...
class TestRenderCelluleJour:
    """Tests pour la fonction render_cellule_jour."""

    @patch("src.modules.planning.calendrier_unifie.components.st")
    def test_render_cellule_basic(self, mock_st: MagicMock) -> None:
        """Test du rendu basique d une cellule."""
        from src.modules.planning.calendrier_unifie.components import render_cellule_jour
...
class TestRenderVueSemaineListe:
    """Tests pour la fonction render_vue_semaine_liste."""

    @patch("src.modules.planning.calendrier_unifie.components.st")
    def test_render_liste_empty(self, mock_st: MagicMock) -> None:
        """Test du rendu d une liste vide."""
        from src.modules.planning.calendrier_unifie.components import render_vue_semaine_liste
...
class TestRenderStatsSemaine:
    """Tests pour la fonction render_stats_semaine."""

    @patch("src.modules.planning.calendrier_unifie.components.st")
    def test_render_stats_empty(self, mock_st: MagicMock) -> None:
        """Test des stats pour une semaine vide."""
        from src.modules.planning.calendrier_unifie.components import render_stats_semaine
...
class TestRenderActionsRapides:
    """Tests pour la fonction render_actions_rapides."""

    @patch("src.modules.planning.calendrier_unifie.components.st")
    def test_render_actions_basic(self, mock_st: MagicMock) -> None:
        """Test du rendu basique des actions rapides."""
        from src.modules.planning.calendrier_unifie.components import render_actions_rapides
...
class TestRenderModalImpression:
    """Tests pour la fonction render_modal_impression."""

    @patch("src.modules.planning.calendrier_unifie.components.st")
    def test_render_modal_closed(self, mock_st: MagicMock) -> None:
        """Test du modal ferme."""
        from src.modules.planning.calendrier_unifie.components import render_modal_impression
    ...
    @patch(
        "src.modules.planning.calendrier_unifie.components.generer_texte_semaine_pour_impression"
    )
    @patch("src.modules.planning.calendrier_unifie.components.st")
...
class TestRenderFormulaireAjoutEvent:
    """Tests pour la fonction render_formulaire_ajout_event."""

    @patch("src.modules.planning.calendrier_unifie.components.st")
    def test_render_formulaire_closed(self, mock_st: MagicMock) -> None:
        """Test du formulaire ferme."""
        from src.modules.planning.calendrier_unifie.components import render_formulaire_ajout_event
...
class TestRenderLegende:
    """Tests pour la fonction render_legende."""

    @patch("src.modules.planning.calendrier_unifie.components.st")
    def test_render_legende_basic(self, mock_st: MagicMock) -> None:
        """Test du rendu basique de la legende."""
        from src.modules.planning.calendrier_unifie.components import render_legende
