...
class TestAppFunction:
    ...
    @patch("src.modules.planning.calendrier_unifie.charger_donnees_semaine")
    @patch("src.modules.planning.calendrier_unifie.st")
    def test_app_basic_render(self, mock_st: MagicMock, mock_charger: MagicMock) -> None:
        """Test du rendu basique de l app."""
        from src.modules.planning.calendrier_unifie import app
