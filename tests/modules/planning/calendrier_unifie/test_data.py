"""
Tests pour src/modules/planning/calendrier_unifie/data.py
...
class TestChargerDonneesSemaine:
    ...
    def mock_db_context(self):
        ...
        with patch("src.modules.planning.calendrier_unifie.data.obtenir_contexte_db") as mock_ctx:
    ...
    def mock_date_utils(self):
        ...
        with patch("src.modules.planning.calendrier_unifie.data.get_debut_semaine") as mock:
    ...
    def test_retourne_structure_vide_par_defaut(self, mock_db_context, mock_date_utils):
        ...
        from src.modules.planning.calendrier_unifie.data import charger_donnees_semaine
    ...
    def test_gere_erreur_table_maintenance_non_disponible(self, mock_db_context, mock_date_utils):
        ...
        with patch("src.modules.planning.calendrier_unifie.data.logger"):
            from src.modules.planning.calendrier_unifie.data import (
