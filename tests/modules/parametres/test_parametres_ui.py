...
class TestParametresUI:
    ...
    @patch("src.modules.parametres.render_budget_config")
    @patch("src.modules.parametres.render_display_config")
    ...
    @patch("src.modules.parametres.render_foyer_config")
    ...
    def test_render_foyer_config(self, mock_st, mock_etat) -> None:
        """Test config foyer."""
        from src.modules.parametres import render_foyer_config
    ...
    def test_render_ia_config(self, mock_st, mock_settings) -> None:
        """Test config IA."""
        from src.modules.parametres import render_ia_config
    ...
    def test_render_database_config(self, mock_st, mock_health, mock_info) -> None:
        ...
        from src.modules.parametres import render_database_config
    ...
    def test_render_cache_config(self, mock_st, mock_sem, mock_cache) -> None:
        """Test config cache."""
        from src.modules.parametres import render_cache_config
    ...
    def test_render_display_config(self, mock_st) -> None:
        ...
        from src.modules.parametres import render_display_config
    ...
    def test_render_budget_config_exists(self) -> None:
        ...
        from src.modules.parametres import render_budget_config
    ...
    def test_render_about(self, mock_st) -> None:
        """Test page a propos."""
        from src.modules.parametres import render_about
