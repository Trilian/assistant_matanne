...
def sample_ingredients(ingredient_factory):
    ...
    return {
        "poulet": ingredient_factory.create("Poulet", "kg", "Prot̩ines"),
...
def sample_suggestions():
    ...
    mock_suggestions = [
        Mock(nom='Tomates', quantite=2.0, unite='kg', priorite='haute', rayon='Fruits & L̩gumes'),
        Mock(nom='Oeufs', quantite=6.0, unite='pi̬ce', priorite='moyenne', rayon='Laitier'),
        Mock(nom='Pain', quantite=1.0, unite='pi̬ce', priorite='moyenne', rayon='Boulangerie')
    ]
