...
class TestDetectBarcodePyzbar:
    ...
    def test_detect_with_mocked_pyzbar(self):
        ...
        with patch.dict(sys.modules, {'pyzbar': mock_pyzbar_module, 'pyzbar.pyzbar': mock_pyzbar_module, 'cv2': mock_cv2}):
...
class TestBarcodeScanner:
    ...
    def test_render_fallback_with_code(self, mock_success, mock_btn, mock_input, mock_warn, mock_md):
...
class TestRenderCameraScannerSimple:
    ...
    def test_photo_with_codes(self, mock_detect, mock_metric, mock_cols, mock_success, mock_camera, mock_info, mock_md):
...
class TestRenderBarcodeScannerWidget:
    ...
    @patch("streamlit.button", return_value=True)
    @patch("streamlit.success")
    def test_manual_with_code_no_callback(self, mock_success, mock_btn, mock_input, mock_md, mock_radio):
