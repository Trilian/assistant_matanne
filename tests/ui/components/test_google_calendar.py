...
class TestRenderGoogleCalendarConfig:
    ...
    @patch("src.ui.components.google_calendar_sync.verifier_config_google")
    def test_render_config_ok_not_connected(self, mock_verif, mock_btn, mock_info, mock_success, mock_md):
    ...
    @patch("streamlit.session_state", MockSessionState({"google_calendar_config": MagicMock(name="Mon Cal", last_sync=datetime.now())}))
    @patch("streamlit.markdown")
    @patch("streamlit.success")
    ...
    @patch("streamlit.button", return_value=False)
    @patch("src.ui.components.google_calendar_sync.verifier_config_google")
    def test_render_config_connected(self, mock_verif, mock_btn, mock_cols, mock_caption, mock_success, mock_md):
    ...
    @patch("streamlit.session_state", MockSessionState({"google_calendar_config": MagicMock(name="Cal", last_sync=datetime.now())}))
    @patch("streamlit.markdown")
    @patch("streamlit.success")
    @patch("streamlit.caption")
    @patch("streamlit.columns")
    ...
    def test_render_sync_button(self, mock_service, mock_verif, mock_rerun, mock_spinner, mock_btn, mock_cols, mock_caption, mock_success, mock_md):
    ...
    @patch("streamlit.rerun")
    @patch("src.ui.components.google_calendar_sync.verifier_config_google")
    def test_render_disconnect_button(self, mock_verif, mock_rerun, mock_btn, mock_cols, mock_caption, mock_success, mock_md):
...
class TestRenderSyncStatus:
    ...
    @patch("streamlit.session_state", MockSessionState({"google_calendar_config": MagicMock(last_sync=None)}))
    ...
    @patch("streamlit.session_state", MockSessionState({"google_calendar_config": MagicMock(last_sync=datetime.now())}))
    @patch("streamlit.success")
...
class TestConnectFlow:
    ...
    @patch("src.ui.components.google_calendar_sync.verifier_config_google")
    @patch("src.ui.components.google_calendar_sync.get_calendar_sync_service")
    def test_connect_button_shows_auth_url(self, mock_service, mock_verif, mock_input, mock_btn, mock_info, mock_success, mock_md):
    ...
    @patch("src.ui.components.google_calendar_sync.verifier_config_google")
    @patch("src.ui.components.google_calendar_sync.get_calendar_sync_service")
    def test_validate_auth_code(self, mock_service, mock_verif, mock_rerun, mock_spinner, mock_input, mock_btn, mock_info, mock_success, mock_md):
    ...
    @patch("src.ui.components.google_calendar_sync.verifier_config_google")
    @patch("src.ui.components.google_calendar_sync.get_calendar_sync_service")
    def test_connect_error(self, mock_service, mock_verif, mock_error, mock_btn, mock_info, mock_success, mock_md):
