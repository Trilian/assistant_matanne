...
class TestListeDynamiqueRender:
    ...
    def test_liste_dynamique_render_empty(self, mock_info, mock_btn, mock_cols, mock_expander):
    ...
    @patch("streamlit.button")
    @patch("streamlit.rerun")
    def test_liste_dynamique_render_add_click(self, mock_rerun, mock_btn, mock_cols, mock_expander):
...
class TestAssistantEtapesRender:
    ...
    def test_assistant_etapes_render_first_step(self, mock_md, mock_cols, mock_progress):
    ...
    @patch("streamlit.columns")
    @patch("streamlit.markdown")
    def test_assistant_etapes_render_middle_step(self, mock_md, mock_cols, mock_progress):
    ...
    @patch("streamlit.columns")
    @patch("streamlit.markdown")
    def test_assistant_etapes_render_last_step(self, mock_md, mock_cols, mock_progress):
