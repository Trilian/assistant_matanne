...
class TestConfigurationIO:
    ...
    def test_alias_io_config(self):
        """Test alias IOConfig."""
        from src.ui.core.base_io import IOConfig, ConfigurationIO
...
class TestServiceIOBaseExport:
    ...
    def test_creation(self):
        """Test création."""
        from src.ui.core.base_io import ServiceIOBase, ConfigurationIO
    ...
    def test_to_csv(self, mock_io_cls):
        ...
        mock_io.to_csv.assert_called_once_with(
            items=items,
            field_mapping={"nom": "Nom"}
        )
...
class TestFactory:
    ...
    def test_creer_service_io(self, mock_io_cls):
        ...
        from src.ui.core.base_io import creer_service_io, ConfigurationIO, ServiceIOBase
