...
# CONSTRUCTEUR FORMULAIRE - CRÃ‰ATION
# â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
...
class TestConstructeurFormulaireCreation:
    ...
    def test_alias_form_builder(self):
        ...
        from src.ui.core.base_form import FormBuilder, ConstructeurFormulaire
...
class TestRenderFormulaire:
    ...
    def test_render_submit_invalid(self, mock_error, mock_submit, mock_cols, mock_form, mock_md, mock_input):
