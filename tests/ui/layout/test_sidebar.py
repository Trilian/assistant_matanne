...
class TestAfficherSidebarInteractions:
    ...
    @patch("src.ui.layout.sidebar.obtenir_etat")
    @patch("src.ui.layout.sidebar.GestionnaireEtat")
    def test_sidebar_debug_mode(self, mock_gest, mock_etat, mock_stats, mock_st, mock_menu, mock_loader, mock_cache):
    ...
    @patch("src.ui.layout.sidebar.obtenir_etat")
    @patch("src.ui.layout.sidebar.GestionnaireEtat")
    def test_sidebar_reset_click(self, mock_gest, mock_etat, mock_stats, mock_st, mock_menu, mock_loader, mock_cache):
        """Test clic sur Reset."""
        from src.ui.layout.sidebar import afficher_sidebar
