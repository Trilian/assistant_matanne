...
class TestTabletMode:
    ...
    def test_tablet_css_exists(self):
        """Test que le CSS tablette est défini"""
...
class TestEmptyState:
    ...
    def test_empty_state_avec_subtext(self, mock_markdown):
        """Test état vide avec sous-texte"""
        from src.ui.components.atoms import empty_state
...
class TestMetricCard:
    ...
    def test_metric_card_avec_delta(self, mock_markdown):
        """Test carte métrique avec delta"""
        from src.ui.components.atoms import metric_card
    ...
    def test_metric_card_avec_couleur(self, mock_markdown):
        """Test carte métrique avec couleur"""
        from src.ui.components.atoms import metric_card
...
class TestToast:
    ...
    def test_toast_success(self, mock_success):
        ...
        mock_success.assert_called_once_with("Sauvegarde réussie")
...
class TestToastHelpers:
    ...
    def test_show_success(self):
        """Test show_success"""
        from src.ui.feedback.toasts import show_success, ToastManager
    ...
    def test_show_error(self):
        """Test show_error"""
        from src.ui.feedback.toasts import show_error, ToastManager
    ...
    def test_show_warning(self):
        """Test show_warning"""
        from src.ui.feedback.toasts import show_warning, ToastManager
...
class TestProgressTracker:
    ...
    def test_progress_tracker_error(self, mock_progress, mock_empty):
        ...
        # Vérifier que error() a été appelé sur le placeholder
