...
from src.services.rapports.types import DonneesRecettePDF, DonneesPlanningPDF, DonneesCoursesPDF
...
class TestServiceExportPDFCourses:
    ...
    def test_donnees_courses_pdf_creation(self):
        ...
        data = DonneesCoursesPDF(
            ...
            total_articles=1,
            par_categorie={"fruits_legumes": [{"nom": "Pommes", "quantite": 5, "unite": "kg", "urgent": False}]}
        )
    ...
    def test_generer_pdf_courses(self, service):
        ...
        data = DonneesCoursesPDF(
            ...
            total_articles=2,
            par_categorie={
                "produits_laitiers": [{"nom": "Lait", "quantite": 2, "unite": "L", "urgent": False}],
    ...
    def test_generer_pdf_courses_toutes_categories(self, service):
        ...
        par_cat = {
            ...
            "produits_laitiers": [{"nom": "Fromage", "quantite": 100, "unite": "g", "urgent": False}],
    ...
    def test_exporter_liste_courses_mock(self, service):
        ...
        with patch('src.services.rapports.export.obtenir_contexte_db') as mock_ctx:
            mock_db = MagicMock()
            mock_db.query.return_value.filter.return_value.order_by.return_value.all.return_value = [mock_article]
            mock_ctx.return_value.__enter__ = MagicMock(return_value=mock_db)
            mock_ctx.return_value.__exit__ = MagicMock(return_value=False)
    ...
    def test_exporter_liste_courses_multi_articles(self, service):
        ...
        with patch('src.services.rapports.export.obtenir_contexte_db') as mock_ctx:
            mock_db = MagicMock()
            mock_db.query.return_value.filter.return_value.order_by.return_value.all.return_value = [mock_article1, mock_article2]
            mock_ctx.return_value.__enter__ = MagicMock(return_value=mock_db)
            mock_ctx.return_value.__exit__ = MagicMock(return_value=False)
