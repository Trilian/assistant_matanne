...
class TestUserProfile:
    ...
    def test_display_name_with_names(self):
        """Test nom d'affichage avec pr̩nom et nom."""
        profile = UserProfile(
            email="test@example.com",
            nom="Dupont",
            prenom="Jean",
    ...
    def test_display_name_without_names(self):
        """Test nom d'affichage sans pr̩nom/nom."""
    ...
    def test_has_permission_invite(self):
        """Test permissions pour un invit̩."""
...
class TestRolePermissions:
    ...
    def test_invite_has_read_only(self):
        """L'invit̩ a seulement les permissions de lecture."""
...
class TestAuthResult:
    """Tests pour le mod̬le AuthResult."""
    
    def test_success_result(self):
        """Test r̩sultat de succ̬s."""
...
class TestAuthService:
    ...
    def test_login_not_configured(self):
        """Test connexion quand non configur̩."""
        service = AuthService()
        service._client = None
    ...
    def test_logout_always_succeeds(self):
        """Test d̩connexion r̩ussit toujours."""
        service = AuthService()
        service._client = None
    ...
    def test_reset_password_not_configured(self):
        """Test reset password quand non configur̩."""
        service = AuthService()
        service._client = None
    ...
    def test_get_current_user_not_logged_in(self):
        """Test utilisateur courant non connect̩."""
        service = AuthService()
    ...
    def test_get_current_user_logged_in(self, mock_state):
        """Test utilisateur courant connect̩."""
        user = UserProfile(email="test@example.com")
    ...
    def test_factory_singleton(self):
        """Test que la factory retourne le m̻me service."""
...
class TestAuthServiceWithMockSupabase:
    """Tests avec Supabase mock̩."""
    
    @pytest.fixture
    def mock_supabase_client(self):
        """Fixture pour un client Supabase mock̩."""
        client = Mock()
        client.auth = Mock()
        return client
    ...
    def auth_service(self, mock_supabase_client):
        """Fixture pour le service avec Supabase mock̩."""
        service = AuthService()
...
class TestDecorators:
    """Tests pour les d̩corateurs d'authentification."""
    ...
    def test_require_authenticated_not_logged_in(
        ...
        """Test d̩corateur sans authentification."""
        mock_auth = Mock()
    ...
    def test_require_authenticated_logged_in(self, mock_get_auth):
        """Test d̩corateur avec authentification."""
        mock_auth = Mock()
    ...
    def test_require_role_not_logged_in(
        ...
        """Test d̩corateur de r̫le sans authentification."""
        mock_auth = Mock()
    ...
    def test_require_role_insufficient(self, mock_error, mock_get_auth):
        """Test d̩corateur de r̫le avec r̫le insuffisant."""
        mock_auth = Mock()
    ...
    def test_require_role_sufficient(self, mock_get_auth):
        """Test d̩corateur de r̫le avec r̫le suffisant."""
        mock_auth = Mock()
