...
class TestObtenirNotifications:
    ...
    def test_obtenir_notifications_avec_notifs(self, service, sample_article, sample_article_critico):
    ...
    def test_obtenir_notifications_non_lues_seulement(self, service, sample_article, sample_article_critico):
    ...
    def test_notifications_triees_par_priorite(self, service, sample_article, sample_article_critico):
