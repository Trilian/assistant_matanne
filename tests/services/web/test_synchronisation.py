...
class TestHandlers:
    ...
    def test_handle_presence_join(self, mock_st):
        ...
        payload = {
            "key": "user3",
            "newPresences": [{"user_id": "user3", "user_name": "Charlie"}]
        }
    ...
    def test_handle_presence_leave(self, mock_st):
        ...
        from src.services.web.synchronisation import RealtimeSyncService, PresenceInfo
        
        service = RealtimeSyncService()
        service.state.users_present["user3"] = PresenceInfo(
            user_id="user3", user_name="Charlie"
        )
...
class TestUIComponents:
    ...
    def test_render_sync_status_pending(self, mock_get_service, mock_st):
        ...
        from src.services.web.synchronisation import SyncState, SyncEvent, SyncEventType
...
class TestInitClient:
    ...
    def test_init_client_with_supabase_config(self, mock_st):
        ...
        with patch("src.services.web.synchronisation.create_client", create=True) as mock_create:
            ...
            with patch("src.services.web.synchronisation.obtenir_parametres", return_value=mock_params, create=True):
                service = RealtimeSyncService()
...
class TestGetCurrentUser:
    ...
    def test_get_current_user_id_with_user(self, mock_st):
        ...
        with patch("src.services.web.synchronisation.get_auth_service", return_value=mock_auth, create=True):
            from src.services.web.synchronisation import RealtimeSyncService
