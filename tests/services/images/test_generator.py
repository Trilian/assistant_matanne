...
class TestConstruireQueryOptimisee:
    ...
    def test_query_basique_nom_seul(self):
        ...
        from src.services.integrations.images.generator import _construire_query_optimisee
...
class TestConstruirePromptDetaille:
    ...
    def test_prompt_basique(self):
        ...
        from src.services.integrations.images.generator import _construire_prompt_detaille
...
class TestRechercherImagePexels:
    ...
    def test_sans_cle_api(self):
        ...
        from src.services.integrations.images.generator import _rechercher_image_pexels

        with patch("src.services.integrations.images.generator.PEXELS_API_KEY", None):
            assert _rechercher_image_pexels("Tarte") is None

    @patch("src.services.integrations.images.generator.PEXELS_API_KEY", "fake_key")
    @patch("requests.get")
...
class TestRechercherImagePixabay:
    ...
    def test_sans_cle_api(self):
        """Retourne None sans clé API."""
        from src.services.integrations.images.generator import _rechercher_image_pixabay

        with patch("src.services.integrations.images.generator.PIXABAY_API_KEY", None):
            assert _rechercher_image_pixabay("Salade") is None

    @patch("src.services.integrations.images.generator.PIXABAY_API_KEY", "fake_key")
    @patch("requests.get")
    def test_avec_resultats(self, mock_get):
        """Retourne URL si résultats trouvés."""
        from src.services.integrations.images.generator import _rechercher_image_pixabay
...
class TestRechercherImageUnsplash:
    ...
    def test_sans_cle_api(self):
        """Retourne None sans clé API."""
        from src.services.integrations.images.generator import _rechercher_image_unsplash

        with patch("src.services.integrations.images.generator.UNSPLASH_API_KEY", None):
            assert _rechercher_image_unsplash("Crêpes") is None

    @patch("src.services.integrations.images.generator.UNSPLASH_API_KEY", "fake_key")
    @patch("requests.get")
    def test_avec_resultats(self, mock_get):
        """Retourne URL si résultats trouvés."""
        from src.services.integrations.images.generator import _rechercher_image_unsplash
...
class TestGenererViaPollinations:
    ...
    def test_genere_url_valide(self, mock_head):
        ...
        from src.services.integrations.images.generator import _generer_via_pollinations
...
class TestGenererViaHuggingface:
    ...
    def test_sans_cle_api(self):
        """Retourne None sans clé API."""
        from src.services.integrations.images.generator import _generer_via_huggingface
...
class TestGenererViaLeonardo:
    ...
    def test_sans_cle_api(self):
        """Retourne None sans clé API."""
        from src.services.integrations.images.generator import _generer_via_leonardo
...
class TestGenererViaReplicate:
    ...
    def test_sans_cle_api(self):
        """Retourne None sans clé API."""
        from src.services.integrations.images.generator import _generer_via_replicate
...
class TestGenererImageRecette:
    ...
    @patch("src.services.integrations.images.generator._generer_via_pollinations")
    def test_fallback_pollinations(self, mock_pollinations):
        """Utilise Pollinations en dernier recours quand aucune API configurée."""
        from src.services.integrations.images.generator import generer_image_recette

        mock_pollinations.return_value = "https://pollinations.ai/test.jpg"

        with (
            patch("src.services.integrations.images.generator.UNSPLASH_API_KEY", None),
            patch("src.services.integrations.images.generator.PEXELS_API_KEY", None),
            patch("src.services.integrations.images.generator.PIXABAY_API_KEY", None),
            patch("src.services.integrations.images.generator.LEONARDO_API_KEY", None),
...
class TestTelechargerImageDepuisUrl:
    ...
    def test_telechargement_reussi(self, mock_get):
        ...
        from src.services.integrations.images.generator import telecharger_image_depuis_url
...
class TestGetApiKey:
    ...
    def test_get_api_key_from_env(self):
        ...
        from src.services.integrations.images.generator import _get_api_key
