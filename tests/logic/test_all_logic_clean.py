"""
Tests complets des modules *_logic.py - Architecture refactoris̩e
Tests purs de logique m̩tier sans d̩pendance Streamlit/DB
"""
import pytest
...
class TestRecettesLogic:
    def test_valider_recette_valide(self):
        ...
        data = {
            ...
            "instructions": ["Cuire les p̢tes", "M̩langer"],
            "portions": 4  # Requis et doit ̻tre > 0
        }
...
class TestInventaireLogic:
    ...
    def test_filtrer_par_emplacement(self):
        ...
        articles = [
            {"nom": "Tomate", "emplacement": "R̩frig̩rateur"},
            {"nom": "P̢tes", "emplacement": "Placard"},
            {"nom": "Lait", "emplacement": "R̩frig̩rateur"}
        ]
...
class TestCoursesLogic:
    ...
    def test_grouper_par_rayon(self):
        ...
        articles = [
            {"nom": "Tomate", "rayon_magasin": "Fruits & L̩gumes"},
            {"nom": "Lait", "rayon_magasin": "Laitier"},
            {"nom": "Pomme", "rayon_magasin": "Fruits & L̩gumes"}
        ]
...
class TestJardinLogic:
    def test_get_saison_actuelle(self):
        ...
        saison = get_saison_actuelle()  # Pas de param̬tre, utilise date.today()
        # Les saisons attendues: printemps, ̩t̩, automne, hiver
