...
COMMANDES_TELEGRAM: tuple[tuple[str, str], ...] = (
    ...
    ("/briefing", "Briefing matinal complet (météo + repas + tâches + alertes)"),
    ("/quoi-manger", "Suggestions de recettes réalisables avec le stock frigo"),
    ("/rappel [texte] [heure]", "Programmer un rappel. Ex: /rappel sortir poubelles 20:30"),
