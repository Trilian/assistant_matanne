"""
Routes API pour le tableau de bord — section accueil.

Endpoints principaux : tableau de bord agrégé, budget unifié, cuisine,
scores, configuration, alertes contextuelles et insights IA.
"""
