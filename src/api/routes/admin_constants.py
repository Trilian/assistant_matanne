...
_LABELS_JOBS: dict[str, str] = {
    ...
    "briefing_matinal_ia": "Phase 7 — Résumé matinal IA (07h00)",
    "comparateur_abonnements": "Phase 7 — Comparateur abonnements (1er/mois 09h00)",
    "rapport_nutritionnel_jules": "Phase 7 — Rapport nutritionnel Jules (dim 19h00)",
    "nettoyage_notifications_30j": "Phase 7 — Nettoyage notifications 30 jours (1er/mois 02h30)",
    "prediction_depenses": "Phase 7 — Prédiction dépenses (15 du mois 08h30)",
    "alerte_plantes_arrosage": "Phase 7 — Alerte plantes / arrosage (08h00)",
    "sync_tirages_euromillions": "Phase 7 — Sync tirages Euromillions (mar/ven 22h30)",
