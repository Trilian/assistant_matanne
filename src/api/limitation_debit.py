...
class StrategieLimitationDebit(str, Enum):
    ...
    SEAU_A_JETONS = "token_bucket"  # Seau Ã  jetons
...
class LimiteurDebit:
    ...
    def ajouter_headers(self, response: Response, info_limite: dict[str, Any]):
        """Ajoute les headers de limitation de débit Ã  la réponse."""
...
def limite_debit(
    ...
    """
    Décorateur pour appliquer une limite de débit spécifique Ã  un endpoint.
