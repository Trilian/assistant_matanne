...
# ═══════════════════════════════════════════════════════════
# COMPOSANTS UI (rétrocompatibilité — implémentation dans src.ui.views)
# ═══════════════════════════════════════════════════════════

from src.ui.views.pwa import inject_pwa_meta  # noqa: F401  # rétrocompatibilité


def render_install_prompt():
    """Rétrocompatibilité — délègue à src.ui.views.synchronisation."""
    from src.ui.views.synchronisation import afficher_invite_installation_pwa

    return afficher_invite_installation_pwa()
