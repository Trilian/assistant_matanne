"""
Types et schémas pour l'historique des actions utilisateur.

Définit les enums, modèles Pydantic et filtres utilisés
par le service d'historique et le logger d'actions.
"""
