...
# Imports providers pour utilisation dans le service
...
from .prompts import _construire_prompt_detaille, _construire_query_optimisee
...
class ServiceGenerateurImages:
    ...
    Example:
        >>> service = obtenir_image_generator_service()
...
# Alias anglais
obtenir_image_generator_service = obtenir_image_generator_service
