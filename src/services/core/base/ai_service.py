...
Features:
    - Rate limiting intelligent (quotas horaires/quotidiens)
    - Cache sémantique automatique
    - Circuit breaker pour protection service externe
    - Parsing JSON/Pydantic robuste
    - API duale async/sync via ServiceMeta metaclass
    - Pattern Result[T, E] pour contrôle de flux sécurisé
"""
...
class BaseAIService(metaclass=ServiceMeta):
    """
    ...
    # ═══════════════════════════════════════════════════════════
    # STREAMING — Réponse progressive pour UX temps réel
    # ═══════════════════════════════════════════════════════════
