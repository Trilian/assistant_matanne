...
class ServiceNtfy:
    ...
    async def envoyer(self, notification: NotificationNtfy) -> ResultatEnvoiNtfy:
        ...
        # Utilise le format JSON pour supporter les caractères non-ASCII (UTF-8)
        payload: dict = {
...
obtenir_ntfy_service = obtenir_ntfy_service  # alias rétrocompatibilité
