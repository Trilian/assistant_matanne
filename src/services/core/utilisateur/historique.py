...
class ActionHistoryService(HistoriqueQueriesMixin, HistoriqueStatsMixin, HistoriqueUndoMixin):
    ...
    def _get_current_user(self) -> tuple[str, str]:
        ...
        try:
            from src.services.core.utilisateur.authentification import obtenir_auth_service

            auth = obtenir_auth_service()
...
obtenir_action_history_service = obtenir_action_history_service  # alias rétrocompatibilité 
