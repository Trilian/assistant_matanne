...
def configurer_jobs_planifies(planifier_job) -> None:
    ...
    planifier_job(
        "digest_notifications_queue", CronTrigger(hour="*/2", minute=5), replace_existing=True
    )
    ...
    planifier_job(
        "resume_hebdo", CronTrigger(day_of_week="mon", hour=7, minute=30), replace_existing=True
    )
    planifier_job(
    ...
    planifier_job(
        "alertes_peremption_j3_proactive", CronTrigger(hour=7, minute=30), replace_existing=True
    )
    planifier_job(
        "rapport_mensuel_budget", CronTrigger(day=1, hour=8, minute=15), replace_existing=True
    )
    planifier_job(
        "score_weekend", CronTrigger(day_of_week="fri", hour=17, minute=0), replace_existing=True
    )
    planifier_job(
        "rapport_jardin", CronTrigger(day_of_week="wed", hour=20, minute=0), replace_existing=True
    )
    planifier_job(
    ...
    planifier_job(
        "rapport_maison_mensuel", CronTrigger(day=1, hour=9, minute=30), replace_existing=True
    )
    planifier_job(
        "sync_openfoodfacts",
    ...
    planifier_job(
        ...
        CronTrigger(day_of_week="tue,fri", hour=22, minute=30),
        replace_existing=True,
    )
    planifier_job(
        "rapport_budget_hebdo",
    ...
    planifier_job(
        "analyse_tendances_mensuelles", CronTrigger(day=1, hour=9, minute=0), replace_existing=True
    )
    planifier_job(
        "purge_logs_anciens_mensuelle", CronTrigger(day=1, hour=3, minute=0), replace_existing=True
    )
    ...
    planifier_job(
        "resultat_tirage_loto",
        CronTrigger(day_of_week="tue,fri", hour=22, minute=15),
        replace_existing=True,
    )
    planifier_job(
        "nouvelle_recette_saison", CronTrigger(day=1, hour=11, minute=0), replace_existing=True
    )
    planifier_job(
        "tache_jardin_saisonniere",
        CronTrigger(month="3,6,9,12", day=1, hour=6, minute=0),
        replace_existing=True,
    )
    ...
    planifier_job(
        "nettoyage_logs", CronTrigger(day_of_week="sun", hour=4, minute=0), replace_existing=True
    )
    planifier_job("check_garmin_anomalies", CronTrigger(hour=8, minute=0), replace_existing=True)
    planifier_job(
        "resume_jardin_saisonnier", CronTrigger(day=1, hour=8, minute=0), replace_existing=True
    )
    ...
    planifier_job(
        "suggestions_activites_meteo", CronTrigger(hour=7, minute=15), replace_existing=True
    )

    # Jobs connexions inter-modules
    planifier_job(
        "rappel_documents_expirants", CronTrigger(hour=8, minute=0), replace_existing=True
    )
    planifier_job(
        "rapport_mensuel_auto", CronTrigger(day=1, hour=8, minute=0), replace_existing=True
    )
    planifier_job("bilan_energetique", CronTrigger(day=1, hour=8, minute=30), replace_existing=True)
    planifier_job(
        "rappel_vaccins", CronTrigger(day_of_week="mon", hour=9, minute=0), replace_existing=True
    )
    planifier_job(
        "sync_entretien_budget", CronTrigger(day=1, hour=6, minute=0), replace_existing=True
    )
    ...
    planifier_job(
        "optimisation_routines", CronTrigger(day=15, hour=10, minute=0), replace_existing=True
    )
    planifier_job("suggestions_saison", CronTrigger(day=1, hour=9, minute=0), replace_existing=True)
    planifier_job(
        "purge_historique_jeux", CronTrigger(day=1, hour=3, minute=30), replace_existing=True
    )
    ...
    planifier_job(
        "resume_hebdo_ia", CronTrigger(day_of_week="sun", hour=20, minute=30), replace_existing=True
    )
    ...
    planifier_job(
        "sync_resultats_paris_auto", CronTrigger(hour="*/3", minute=10), replace_existing=True
    )
    planifier_job(
        "rapport_jardin_saisonnier", CronTrigger(day=1, hour=8, minute=0), replace_existing=True
    )
    planifier_job(
    ...
    planifier_job(
        "health_check_services_ia", CronTrigger(hour="*/6", minute=0), replace_existing=True
    )
    ...
    planifier_job(
        "backup_auto_hebdo_json",
        CronTrigger(day_of_week="sun", hour=4, minute=0),
        replace_existing=True,
    )
    planifier_job(
        "suggestions_proactives_telegram", CronTrigger(hour=14, minute=0), replace_existing=True
    )

    # Jobs automatisation supplémentaires
    planifier_job(
        "job_expiration_recettes_suggestion", CronTrigger(hour=10, minute=0), replace_existing=True
    )
    planifier_job(
    ...
    planifier_job(
        ...
        CronTrigger(day_of_week="sun", hour=19, minute=30),
        replace_existing=True,
    )
    planifier_job(
        "job_energie_peak_detection", CronTrigger(hour=19, minute=0), replace_existing=True
    )
    planifier_job(
        "job_nutrition_adultes_weekly",
        CronTrigger(day_of_week="sun", hour=20, minute=15),
        replace_existing=True,
    )
    ...
    planifier_job(
        "nettoyage_notifications_30j", CronTrigger(day=1, hour=2, minute=30), replace_existing=True
    )
    planifier_job(
        "prediction_depenses", CronTrigger(day=15, hour=8, minute=30), replace_existing=True
    )
    ...
    planifier_job(
        "s16_rappel_entretien_telegram", CronTrigger(hour=8, minute=10), replace_existing=True
    )
    planifier_job(
    ...
    planifier_job(
        "s16_rapport_famille_mensuel", CronTrigger(day=1, hour=9, minute=0), replace_existing=True
    )
    planifier_job(
        "s16_rapport_maison_trimestriel",
        CronTrigger(month="1,4,7,10", day=1, hour=9, minute=10),
        replace_existing=True,
    )
    ...
    planifier_job(
        ...
        CronTrigger(day=1, hour=9, minute=20),
        replace_existing=True,
    )
