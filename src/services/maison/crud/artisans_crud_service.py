...
def obtenir_artisans_crud_service() -> ArtisansCrudService:
...
def obtenir_service_artisans_crud() -> ArtisansCrudService:
    ...
    return obtenir_artisans_crud_service()


# ─── Aliases rétrocompatibilité  ───────────────────────────────
obtenir_artisans_crud_service = obtenir_artisans_crud_service  # alias rétrocompatibilité 
