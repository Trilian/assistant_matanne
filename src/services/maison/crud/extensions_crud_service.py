...
obtenir_nuisibles_crud_service = obtenir_nuisibles_crud_service  # alias rétrocompatibilité 
obtenir_devis_crud_service = obtenir_devis_crud_service  # alias rétrocompatibilité 
obtenir_entretien_saisonnier_crud_service = obtenir_entretien_saisonnier_crud_service  # alias rétrocompatibilité 
obtenir_releves_crud_service = obtenir_releves_crud_service  # alias rétrocompatibilité 
