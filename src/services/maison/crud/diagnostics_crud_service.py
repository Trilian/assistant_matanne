...
def obtenir_service_diagnostics_crud() -> DiagnosticsCrudService:
    ...
    return obtenir_diagnostics_crud_service()


def obtenir_service_estimations_crud() -> EstimationsCrudService:
    """Factory française pour le service CRUD estimations."""
    return obtenir_estimations_crud_service()


# ─── Aliases rétrocompatibilité  ───────────────────────────────
obtenir_diagnostics_crud_service = obtenir_diagnostics_crud_service  # alias rétrocompatibilité 
obtenir_estimations_crud_service = obtenir_estimations_crud_service  # alias rétrocompatibilité 
