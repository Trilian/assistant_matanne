"""
Mixin IA Jardin — Méthodes d'intelligence artificielle du service jardin.

Extrait de jardin_service.py pour maintenir chaque fichier sous 500 LOC.
Contient:
- Conseils saisonniers IA
- Suggestions de plantes
- Arrosage intelligent (IA + algorithmique)
- Diagnostic plantes par vision IA
...
class JardinIAMixin:
    """Mixin fournissant les méthodes IA du service jardin.
...
{{"plante": "nom", "etat": "bon", "problemes": [...], "traitements": [...]}}"""
    ...
    def get_saison_actuelle() -> str:
        ...
        return JardinIAMixin.obtenir_saison_actuelle()
