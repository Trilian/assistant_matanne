...
class NotificationsMaisonService:
    ...
    def evaluer_et_envoyer_rappels(self) -> RappelResult:
        ...
        try:
            from src.services.core.notifications import NotificationNtfy, obtenir_service_ntfy
        ...
        logger.info(
            f"Rappels maison: {result.rappels_envoyes} envoyés, {result.rappels_ignores} ignorés"
        )
...
obtenir_notifications_maison_service = (
    obtenir_notifications_maison_service  # alias rétrocompatibilité
)
