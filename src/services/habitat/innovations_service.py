"""Façade habitat pour les analyses énergie et consommation."""
...
class ServiceInnovationsHabitat:
    """Expose les analyses énergie consolidées dans le module habitat."""
...
@service_factory("habitat_innovations", tags={"habitat", "energie", "ia"})
def obtenir_service_innovations_habitat() -> ServiceInnovationsHabitat:
    """Retourne la façade IA habitat consolidée."""
    return ServiceInnovationsHabitat()
