...
class ServiceRappelsFamille:
    ...
    def _rappels_maison(self) -> list[dict[str, Any]]:
        ...
        rappels: list[dict[str, Any]] = []
        try:
            from src.services.maison.contexte_maison_service import obtenir_contexte_maison_service

            briefing = obtenir_contexte_maison_service().obtenir_briefing()
            if not briefing:
                return []
...
# Alias anglais
obtenir_service_rappels_famille = obtenir_service_rappels_famille
