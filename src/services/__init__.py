...
Importez directement depuis les sous-packages:
    ...
    from src.services.core.utilisateur import AuthService, obtenir_auth_service
    ...
    from src.services.integrations.multimodal import MultiModalAIService, obtenir_multimodal_service

    # Webhooks
    from src.services.integrations.webhooks import WebhookService, obtenir_webhook_service

    # Profils utilisateurs
    from src.services.core.utilisateur.profils import ProfilService, obtenir_profil_service
