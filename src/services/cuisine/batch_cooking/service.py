...
class ServiceBatchCooking(
    ...
    def update_config(
        ...
        couverture_jours: dict | None = None,
        notes: str | None = None,
        ...
        if couverture_jours is not None:
            config.couverture_jours = couverture_jours
...
__all__ = [
    ...
    "obtenir_batch_cooking_service",
]


# ─── Aliases rétrocompatibilité  ───────────────────────────────

obtenir_batch_cooking_service = obtenir_batch_cooking_service  # alias rétrocompatibilité
