...
Utilisation:
    service = obtenir_paris_crud_service()
...
def obtenir_service_paris_crud() -> ParisCrudService:
    """Alias français pour obtenir_paris_crud_service."""
    return obtenir_paris_crud_service()


# ─── Aliases rétrocompatibilité  ───────────────────────────────
obtenir_paris_crud_service = obtenir_paris_crud_service  # alias rétrocompatibilité 
