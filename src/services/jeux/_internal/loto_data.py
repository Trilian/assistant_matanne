...
def obtenir_service_donnees_loto() -> LotoDataService:
    """
    Alias français pour obtenir_loto_data_service (singleton via registre).

    Returns:
        Instance LotoDataService
    """
    return obtenir_loto_data_service()


# ─── Aliases rétrocompatibilité  ───────────────────────────────
obtenir_loto_data_service = obtenir_loto_data_service  # alias rétrocompatibilité 
