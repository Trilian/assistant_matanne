...
def obtenir_service_notifications_jeux() -> NotificationJeuxService:
    """Alias français pour obtenir_notification_jeux_service (singleton via registre)."""
    return obtenir_notification_jeux_service()
...
obtenir_notification_jeux_service = obtenir_notification_jeux_service  # alias rétrocompatibilité 
