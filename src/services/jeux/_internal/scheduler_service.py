...
Usage:
    scheduler = obtenir_scheduler_service()
...
from .sync_service import SyncService, obtenir_sync_service
...
class SchedulerService:
    ...
    def __init__(
        ...
        """
        self.sync_service = sync_service or obtenir_sync_service()
...
def obtenir_service_planificateur_jeux(
    ...
    """Alias français pour obtenir_scheduler_service (singleton via registre)."""
    if sync_service is not None or api_key_football is not None:
        return obtenir_scheduler_service(
            sync_service=sync_service,
            api_key_football=api_key_football,
        )
    return obtenir_scheduler_service()
...
obtenir_scheduler_service = obtenir_scheduler_service  # alias rétrocompatibilité 
