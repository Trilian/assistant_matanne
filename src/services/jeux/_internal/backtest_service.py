...
class ResultatPrediction(StrEnum):
...
def obtenir_service_backtest() -> BacktestService:
    """Alias français pour obtenir_backtest_service (singleton via registre)."""
    return obtenir_backtest_service()
...
obtenir_backtest_service = obtenir_backtest_service  # alias rétrocompatibilité 
