...
def obtenir_service_predictions_jeux() -> PredictionServiceJeux:
    """Alias français pour obtenir_prediction_service (singleton via registre)."""
    return obtenir_prediction_service()
...
def predire_resultat_match(
    ...
    service = obtenir_prediction_service()
...
obtenir_prediction_service = obtenir_prediction_service  # alias rétrocompatibilité 
