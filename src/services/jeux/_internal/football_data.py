...
def obtenir_service_donnees_football(api_key: str | None = None) -> FootballDataService:
    ...
    return obtenir_football_data_service(api_key)


# ═══════════════════════════════════════════════════════════
# RÉ-EXPORTS COMPATIBILITÉ (depuis football_compat.py)
# ═══════════════════════════════════════════════════════════

from .football_compat import (  # noqa: E402, F401
    CHAMP_MAPPING,
    charger_classement,
...
obtenir_football_data_service = obtenir_football_data_service  # alias rétrocompatibilité 
