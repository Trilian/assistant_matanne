...
Utilisation:
    sync_service = obtenir_sync_service()
...
from .series_service import SEUIL_VALUE_ALERTE, obtenir_series_service
...
class SyncService:
    ...
    def __init__(self):
        ...
        self.series_service = obtenir_series_service()
...
def obtenir_service_sync_jeux() -> SyncService:
    """
    Alias français pour obtenir_sync_service (singleton via registre).

    Returns:
        Instance SyncService
    """
    return obtenir_sync_service()


# ─── Aliases rétrocompatibilité  ───────────────────────────────
obtenir_sync_service = obtenir_sync_service  # alias rétrocompatibilité 
