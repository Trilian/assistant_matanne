...
export const PAGES_NAVIGATION: PageNavigation[] = [
  ...
  { nom: "Vision Maison", chemin: "/vision-maison", categorie: "Vision Maison", Icone: Map, keywords: ["logement", "immo", "deco", "jardin"] },
  { nom: "Scénarios", chemin: "/vision-maison/scenarios", categorie: "Vision Maison", Icone: Home, keywords: ["comparaison", "decision"] },
  { nom: "Veille Immo", chemin: "/vision-maison/veille-immo", categorie: "Vision Maison", Icone: ShoppingBag, keywords: ["annonces", "immobilier"] },
  { nom: "Marché", chemin: "/vision-maison/marche", categorie: "Vision Maison", Icone: TrendingUp, keywords: ["dvf", "prix", "transactions"] },
  { nom: "Plans", chemin: "/vision-maison/plans", categorie: "Vision Maison", Icone: Layers, keywords: ["plans", "pieces", "architecture"] },
  { nom: "Déco", chemin: "/vision-maison/deco", categorie: "Vision Maison", Icone: House, keywords: ["interieur", "meubles", "style"] },
  { nom: "Jardin Design", chemin: "/vision-maison/jardin", categorie: "Vision Maison", Icone: Sprout, keywords: ["paysagisme", "zones", "terrain"] },
