...
export interface TelegramConversationnelResponse {
  actif: boolean;
  nb_commandes: number;
...
export async function obtenirModePiloteAuto(): Promise<ModePiloteAutoResponse> {
  const { data } = await clientApi.get("/api/v1/preferences/mode-pilote");
  return data;
}
...
export async function configurerModePiloteAuto(
  ...
  const { data } = await clientApi.post("/api/v1/preferences/mode-pilote/config", payload);
  return data;
}

export async function obtenirScoreFamilleHebdo(): Promise<ScoreFamilleHebdoResponse> {
  const { data } = await clientApi.get("/api/v1/famille/score-famille-hebdo");
  return data;
}

export async function obtenirJournalFamilialAuto(): Promise<JournalFamilialAutoResponse> {
  const { data } = await clientApi.get("/api/v1/rapports/journal-familial");
  return data;
}

export async function obtenirJournalFamilialPdf(): Promise<RapportMensuelPdfResponse> {
  const { data } = await clientApi.get("/api/v1/rapports/journal-familial/pdf");
  return data;
}

export async function obtenirRapportMensuelPdf(mois?: string): Promise<RapportMensuelPdfResponse> {
  const { data } = await clientApi.get("/api/v1/rapports/rapport-mensuel/pdf", {
    params: { mois },
  });
  return data;
}
...
export async function obtenirSuggestionRepasGarmin(): Promise<SuggestionRepasGarminResponse> {
  const { data } = await clientApi.get("/api/v1/recettes/garmin-repas-adaptatif");
  return data;
}

export async function obtenirModeVacances(): Promise<ModeVacancesResponse> {
  const { data } = await clientApi.get("/api/v1/famille/mode-vacances");
  return data;
}
...
export async function configurerModeVacances(payload: {
  ...
  const { data } = await clientApi.post("/api/v1/famille/mode-vacances/config", payload);
  return data;
}

export async function obtenirInsightsQuotidiens(limite = 2): Promise<InsightsQuotidiensResponse> {
  const { data } = await clientApi.get("/api/v1/dashboard/insights-quotidiens", {
    params: { limite },
  });
  return data;
}
...
export async function obtenirMeteoContextuelle(): Promise<MeteoContextuelleResponse> {
  const { data } = await clientApi.get("/api/v1/dashboard/meteo-contextuelle");
  return data;
}
...
export async function obtenirPreferencesApprises(): Promise<ApprentissagePreferencesResponse> {
  const { data } = await clientApi.get("/api/v1/preferences/preferences-apprises");
  return data;
}

export async function obtenirPlanificationHebdoAuto(): Promise<PlanificationHebdoCompleteResponse> {
  const { data } = await clientApi.get("/api/v1/planning/planification-auto");
  return data;
}

export async function obtenirBatchCookingIntelligent(): Promise<BatchCookingIntelligentResponse> {
  const { data } = await clientApi.get("/api/v1/batch-cooking/intelligent");
  return data;
}
...
export async function genererCarteVisuellePartageable(payload: {
  ...
  const { data } = await clientApi.post("/api/v1/rapports/carte-visuelle", payload);
  return data;
}

export async function obtenirModeTabletteMagazine(): Promise<ModeTabletteMagazineResponse> {
  const { data } = await clientApi.get("/api/v1/rapports/mode-tablette-magazine");
  return data;
}

export async function obtenirTelegramConversationnel(): Promise<TelegramConversationnelResponse> {
  const { data } = await clientApi.get("/api/v1/dashboard/telegram-conversationnel");
  return data;
}

export async function obtenirComparateurPrixAuto(topN = 20): Promise<ComparateurPrixAutomatiqueResponse> {
  const { data } = await clientApi.get("/api/v1/courses/comparateur-prix-auto", {
    params: { top_n: topN },
  });
  return data;
}
...
export async function obtenirEnergieTempsReel(): Promise<EnergieTempsReelResponse> {
  const { data } = await clientApi.get("/api/v1/habitat/energie-temps-reel");
  return data;
}
