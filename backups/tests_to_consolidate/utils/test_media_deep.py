...
class TestImageConfig:
    ...
    def test_image_config_custom_values(self):
        ...
        config = ImageConfig(
            max_width=800, max_height=600, quality=70, format="JPEG", cache_ttl_seconds=7200
        )
...
class TestImageOptimizer:
    ...
    def test_image_optimizer_init_custom_config(self):
        ...
        from src.utils.media import ImageConfig, ImageOptimizer
...
class TestGlobalOptimizer:
    ...
    def test_optimize_uploaded_image_custom_config(self, mock_optimizer_class):
        ...
        from src.utils.media import ImageConfig, optimize_uploaded_image
