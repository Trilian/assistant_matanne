...
class TestIngredientInput:
    ...
    def test_nom_nettoye(self):
        ...
        ingredient = IngredientInput(nom="  farine  ", quantite=2.5, unite="kg")
    ...
    def test_quantite_valide(self):
        ...
        ingredient = IngredientInput(nom="Sucre", quantite=1.0, unite="kg")
...
class TestRepasInput:
    ...
    def test_type_repas_valide(self):
        ...
        repas = RepasInput(date=date.today(), type_repas="DÃ‰JEUNER", portions=4)
...
class TestTacheRoutineInput:
    ...
    def test_nom_nettoye(self):
        ...
        tache = TacheRoutineInput(nom="  se brosser les dents  ", heure="08:00")
...
class TestEntreeJournalInput:
    ...
    def test_domaine_valide(self):
        ...
        entree = EntreeJournalInput(
            domaine="SANTÃ‰", titre="Ma journÃ©e", contenu="Contenu de l'entrÃ©e"
        )
    ...
    def test_titre_nettoye(self):
        ...
        entree = EntreeJournalInput(
            domaine="humeur", titre="  ma super journÃ©e  ", contenu="Contenu"
        )
