...
class TestPerformanceMetricDataclass:
    ...
    def test_performance_metric_creation(self):
        ...
        metric = MetriquePerformance(name="test_metric", duration_ms=150.5)
...
class TestQueryInfoDataclass:
    ...
    def test_query_info_creation(self):
        ...
        info = InfoRequete(
            sql="SELECT * FROM recettes", duration_ms=5.2, table="recettes", operation="SELECT"
        )
    ...
    def test_query_info_with_parameters(self):
        ...
        info = InfoRequete(
            sql="SELECT * FROM recettes WHERE id = :id", duration_ms=3.1, parameters={"id": 42}
        )
...
class TestN1DetectionDataclass:
    ...
    def test_n1_detection_defaults(self):
        ...
        detection = DetectionN1(table="test", parent_table="parent", count=10)
...
class TestPendingOperationExtended:
    ...
    def test_pending_operation_operation_types(self):
        ...
        for op_type in [TypeOperation.CREATE, TypeOperation.UPDATE, TypeOperation.DELETE]:
            op = OperationEnAttente(operation_type=op_type, model_name="Test")
    ...
    def test_pending_operation_to_dict_with_error(self):
        ...
        op = OperationEnAttente(model_name="Test", last_error="Connection timeout", retry_count=3)
        d = op.to_dict()
