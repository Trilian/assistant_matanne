...
class TestOpenFoodFactsServiceParser:
    ...
    def test_parser_produit_minimal(self):
        ...
        data = {"product_name_fr": "Pain de mie", "brands": "Harry's"}
    ...
    def test_parser_produit_fallback_name(self):
        ...
        data = {"product_name": "Bread", "generic_name_fr": "Pain"}
...
class TestImportedIngredient:
    ...
    def test_ingredient_full(self):
        ...
        ingredient = ImportedIngredient(nom="Farine", quantite=250.0, unite="g")
...
class TestImportedRecipe:
    ...
    def test_recipe_full(self):
        """Test with full data"""
        from src.services.recipe_import import ImportedIngredient, ImportedRecipe
...
class TestImportResult:
    ...
    def test_import_result_success(self):
        """Test success result"""
        from src.services.recipe_import import ImportedRecipe, ImportResult

        recipe = ImportedRecipe(nom="Test")
        result = ImportResult(success=True, message="Import r̩ussi", recipe=recipe)
...
class TestRapportStocksSchema:
    ...
    def test_rapport_stocks_custom(self):
        ...
        rapport = RapportStocks(periode_jours=30, articles_total=150, valeur_stock_total=1500.50)
...
class TestRapportBudgetSchema:
    ...
    def test_rapport_budget_custom(self):
        ...
        rapport = RapportBudget(
            depenses_total=850.0, depenses_par_categorie={"Alimentation": 500.0, "Hygi̬ne": 150.0}
        )
...
class TestRapportPlanningSchema:
    ...
    def test_rapport_planning_custom(self):
        ...
        rapport = RapportPlanning(planning_id=1, nom_planning="Semaine 1", total_repas=14)
