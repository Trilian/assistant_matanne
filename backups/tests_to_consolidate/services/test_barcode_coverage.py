...
class TestBarcodeData:
    ...
    def test_barcode_data_custom_values(self):
        ...
        data = BarcodeData(code="12345678", type_code="EAN-8", source="manuel", timestamp=ts)
...
class TestBarcodeRecette:
    ...
    def test_barcode_recette_basic(self):
        ...
        recette = BarcodeRecette(barcode="3017760000000", recette_id=1, nom_recette="G̢teau")
...
class TestScanResultat:
    ...
    def test_scan_resultat_article(self):
        ...
        result = ScanResultat(
            barcode="3017760000000", type_scan="article", details={"nom": "Lait", "quantite": 1}
        )
    ...
    def test_scan_resultat_inconnu(self):
        ...
        result = ScanResultat(
            barcode="9999999999999", type_scan="inconnu", details={"message": "Non trouv̩"}
        )
...
class TestBarcodeServiceArticleOperations:
    ...
    def test_ajouter_article_par_barcode_invalid_code(self):
        ...
        with pytest.raises(ErreurValidation):
            service.ajouter_article_par_barcode(code="invalid!", nom="Test", session=mock_session)
    ...
    def test_ajouter_article_par_barcode_exists(self):
        ...
        with pytest.raises(ErreurValidation):
            service.ajouter_article_par_barcode(
                code="3017760000000", nom="New", session=mock_session
            )
    ...
    def test_incrementer_stock_barcode_success(self):
        ...
        result = service.incrementer_stock_barcode(
            "3017760000000", quantite=1.0, session=mock_session
        )
