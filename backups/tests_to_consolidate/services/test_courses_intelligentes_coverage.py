...
class TestListeCoursesIntelligenteModel:
    ...
    def test_liste_courses_with_articles(self):
        ...
        from src.services.courses_intelligentes import ArticleCourse, ListeCoursesIntelligente
...
class TestSuggestionSubstitutionModel:
    ...
    def test_suggestion_minimal(self):
        ...
        suggestion = SuggestionSubstitution(
            ingredient_original="Beurre", suggestion="Margarine", raison="Alternative vÃ©gÃ©tale"
        )
...
class TestComparerAvecStock:
    ...
    def test_comparer_rien_en_stock(self, mock_client):
        ...
        mock_client.return_value = Mock()
        from src.services.courses_intelligentes import ArticleCourse, CoursesIntelligentesService
...
class TestAjouterAListeCourses:
    ...
    def test_ajouter_nouvel_article(self, mock_client):
        ...
        # Articles Ã  ajouter
        articles = [ArticleCourse(nom="Banane", quantite=6, a_acheter=6, rayon="Fruits & LÃ©gumes")]
...
class TestSuggererSubstitutions:
    ...
    async def test_suggerer_avec_reponse_valide(self, mock_client):
        ...
        mock_ia = Mock()
        mock_ia.appeler = Mock(
            return_value='[{"ingredient_original": "Beurre", "suggestion": "Margarine", "raison": "Moins cher"}]'
        )
        ...
        articles = [ArticleCourse(nom="Beurre", quantite=1, priorite=1)]
    ...
    async def test_suggerer_erreur_json(self, mock_client):
        ...
        articles = [ArticleCourse(nom="Truffe", quantite=1, priorite=1)]
