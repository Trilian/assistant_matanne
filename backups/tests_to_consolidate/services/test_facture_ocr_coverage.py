...
class TestDonneesFacture:
    ...
    def test_donnees_facture_minimal(self):
        ...
        facture = DonneesFacture(fournisseur="EDF", type_energie="electricite", montant_ttc=125.50)
...
class TestResultatOCR:
    ...
    def test_resultat_ocr_success(self):
        ...
        from src.services.facture_ocr import DonneesFacture, ResultatOCR

        donnees = DonneesFacture(fournisseur="EDF", type_energie="electricite", montant_ttc=100.00)
    ...
    def test_resultat_ocr_failure(self):
        ...
        resultat = ResultatOCR(
            succes=False, donnees=None, message="Erreur d'extraction: Image illisible"
        )
...
class TestExtraireMontant:
    ...
    def test_extraire_montant_ttc(self):
        ...
        from src.services.facture_ocr import PATTERNS_MONTANTS, extraire_montant
