...
class TestPlanningUnifiedImports:
    ...
    def test_import_jour_planning(self):
        ...
        jour = JourPlanning(jour="2025-01-15", dejeuner="Pâtes", diner="Soupe")
...
class TestServicesExports:
    """Tests pour vérifier les exports du package services"""
