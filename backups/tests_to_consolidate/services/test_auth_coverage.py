...
class TestLoginDemoMode:
    ...
    def test_login_demo_admin_account(self):
        ...
        with patch.object(AuthService, "_init_client"):
            ...
            with patch("src.services.auth.st") as mock_st:
                ...
                result = service.login(email="anne@matanne.fr", password="password123")
    ...
    def test_login_demo_membre_account(self):
        ...
        with patch.object(AuthService, "_init_client"):
            ...
            with patch("src.services.auth.st") as mock_st:
                ...
                result = service.login(email="demo@test.fr", password="password123")
    ...
    def test_login_demo_invalid_password(self):
        ...
        with patch.object(AuthService, "_init_client"):
            ...
            result = service.login(email="anne@matanne.fr", password="wrongpassword")
    ...
    def test_login_demo_unknown_email(self):
        ...
        with patch.object(AuthService, "_init_client"):
            ...
            result = service.login(email="unknown@email.com", password="password123")
...
class TestSignupCoverage:
    ...
    def test_signup_not_configured(self):
        ...
        with patch.object(AuthService, "_init_client"):
            ...
            result = service.signup(email="test@example.com", password="password123")
...
class TestFactoryFunction:
    ...
    def test_get_auth_service_singleton(self):
        ...
        with patch.object(
            __import__("src.services.auth", fromlist=["AuthService"]).AuthService, "_init_client"
        ):
...
class TestDecorators:
    ...
    def test_require_authenticated_decorator_authenticated(self):
        ...
        from src.services.auth import Role, UserProfile, require_authenticated
    ...
    def test_require_role_decorator_has_role(self):
        ...
        from src.services.auth import Role, UserProfile, require_role
...
class TestRenderFunctions:
    ...
    def test_render_login_form(self):
        ...
        from src.services.auth import render_login_form
...
class TestRenderUserMenu:
    ...
    def test_render_user_menu_authenticated(self):
        ...
        from src.services.auth import Role, UserProfile, render_user_menu
...
class TestRenderProfileSettings:
    ...
    def test_render_profile_settings_authenticated(self):
        ...
        from src.services.auth import Role, UserProfile, render_profile_settings
...
class TestAdditionalCoverage:
    ...
    def test_logout_clears_session(self):
        ...
        with patch.object(AuthService, "_init_client"):
            ...
            with patch("src.services.auth.st") as mock_st:
                session_state = {service.SESSION_KEY: "session", service.USER_KEY: "user"}
    ...
    def test_login_invite_account(self):
        ...
        with patch.object(AuthService, "_init_client"):
            ...
            with patch("src.services.auth.st") as mock_st:
                ...
                result = service.login(email="test@test.fr", password="password123")
        ...
        with patch.object(AuthService, "_init_client"):
            ...
            with patch("src.services.auth.st") as mock_st:
                ...
                result = service.signup(
                    email="nouveau@test.com", password="password123", nom="Nouveau", prenom="Test"
                )
