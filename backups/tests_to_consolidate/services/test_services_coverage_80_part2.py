...
class TestOpenFoodFactsParserFullData:
    ...
    def test_parser_with_labels(self):
        ...
        data = {"product_name_fr": "Yaourt Bio", "labels_tags_fr": ["fr:bio", "en:organic"]}
    ...
    def test_parser_with_allergens(self):
        ...
        data = {"product_name_fr": "Biscuit", "allergens_tags": ["en:gluten", "en:milk"]}
        result = service._parser_produit("123", data)
    ...
    def test_parser_with_traces(self):
        ...
        data = {"product_name_fr": "Chocolat", "traces_tags": ["en:nuts", "en:soy"]}
        result = service._parser_produit("123", data)
    ...
    def test_parser_with_completeness(self):
        ...
        data = {"product_name_fr": "Pain", "completeness": 80}
        result = service._parser_produit("123", data)
    ...
    def test_parser_with_completeness_over_100(self):
        ...
        data = {"product_name_fr": "Pain", "completeness": 150}
        result = service._parser_produit("123", data)
    ...
    def test_parser_with_ingredients_text(self):
        ...
        data = {"product_name_fr": "Biscuit", "ingredients_text_fr": "Farine, sucre, beurre"}
        result = service._parser_produit("123", data)
    ...
    def test_parser_with_origin(self):
        ...
        data = {"product_name_fr": "Yaourt", "origins": "France"}
        result = service._parser_produit("123", data)
...
class TestMarmitonParserConfidence:
    ...
    def test_confidence_minimal(self):
        ...
        from src.services.recipe_import import ImportedRecipe, MarmitonParser
    ...
    def test_confidence_with_ingredients(self):
        ...
        from src.services.recipe_import import ImportedIngredient, ImportedRecipe, MarmitonParser

        recipe = ImportedRecipe(
            nom="Tarte", ingredients=[ImportedIngredient(nom=f"ing{i}") for i in range(6)]
        )
        score = MarmitonParser._calculate_confidence(recipe)
    ...
    def test_confidence_with_steps(self):
        ...
        recipe = ImportedRecipe(nom="Tarte aux pommes", etapes=["Ã‰tape 1", "Ã‰tape 2", "Ã‰tape 3"])
        score = MarmitonParser._calculate_confidence(recipe)
    ...
    def test_confidence_with_time(self):
        ...
        recipe = ImportedRecipe(nom="Tarte aux pommes", temps_preparation=30)
        score = MarmitonParser._calculate_confidence(recipe)
    ...
    def test_confidence_with_image(self):
        ...
        recipe = ImportedRecipe(nom="Tarte aux pommes", image_url="https://example.com/image.jpg")
        score = MarmitonParser._calculate_confidence(recipe)
