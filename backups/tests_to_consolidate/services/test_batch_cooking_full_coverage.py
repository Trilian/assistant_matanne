...
class TestEtapeBatchIA:
    ...
    def test_etape_batch_ia_validation_ordre_min(self):
        ...
        with pytest.raises(pydantic.ValidationError):
            EtapeBatchIA(ordre=0, titre="Test", description="Description", duree_minutes=10)
    ...
    def test_etape_batch_ia_validation_duree_max(self):
        ...
        with pytest.raises(pydantic.ValidationError):
            EtapeBatchIA(ordre=1, titre="Test", description="Description", duree_minutes=200)
    ...
    def test_etape_batch_ia_validation_duree_min(self):
        ...
        with pytest.raises(pydantic.ValidationError):
            EtapeBatchIA(ordre=1, titre="Test", description="Description", duree_minutes=0)
    ...
    def test_etape_batch_ia_duree_limite(self):
        ...
        etape = EtapeBatchIA(
            ordre=1, titre="Longue cuisson", description="Cuisson trÃ¨s longue", duree_minutes=180
        )
...
class TestSessionBatchIA:
    ...
    def test_session_batch_ia_minimal(self):
        """Test crÃ©ation minimale."""
        from src.services.batch_cooking import EtapeBatchIA, SessionBatchIA

        etape = EtapeBatchIA(
            ordre=1, titre="PrÃ©parer", description="PrÃ©parer les ingrÃ©dients", duree_minutes=10
        )

        session = SessionBatchIA(recettes=["Poulet rÃ´ti"], duree_totale_estimee=60, etapes=[etape])
    ...
    def test_session_batch_ia_complete(self):
        ...
        etape1 = EtapeBatchIA(
            ordre=1, titre="Ã‰tape 1", description="PremiÃ¨re Ã©tape", duree_minutes=15
        )
    ...
    def test_session_batch_ia_multiple_etapes(self):
        ...
        session = SessionBatchIA(
            recettes=["Recette 1", "Recette 2", "Recette 3"], duree_totale_estimee=55, etapes=etapes
        )
    ...
    def test_session_batch_ia_validation_recettes_vides(self):
        ...
        etape = EtapeBatchIA(ordre=1, titre="Test", description="Description", duree_minutes=10)

        with pytest.raises(pydantic.ValidationError):
            SessionBatchIA(recettes=[], duree_totale_estimee=60, etapes=[etape])
...
class TestPreparationIA:
    ...
    def test_preparation_ia_minimal(self):
        ...
        prep = PreparationIA(nom="Sauce tomate", portions=4, conservation_jours=7)
    ...
    def test_preparation_ia_validation_portions_max(self):
        ...
        with pytest.raises(pydantic.ValidationError):
            PreparationIA(nom="Test", portions=50, conservation_jours=7)
    ...
    def test_preparation_ia_validation_portions_min(self):
        ...
        with pytest.raises(pydantic.ValidationError):
            PreparationIA(nom="Test", portions=0, conservation_jours=7)
    ...
    def test_preparation_ia_longue_conservation(self):
        ...
        prep = PreparationIA(
            nom="Plat congelÃ©", portions=6, conservation_jours=90, localisation="congelateur"
        )
    ...
    def test_preparation_ia_portion_limite(self):
        ...
        prep = PreparationIA(nom="Grande prÃ©paration", portions=20, conservation_jours=14)
...
class TestPreparationsMocked:
    ...
    def test_creer_preparation(self, mock_client):
        ...
        result = service.creer_preparation(nom="Nouvelle sauce", portions=4, conservation_jours=7)
...
class TestIAMocked:
    ...
    def test_generer_plan_ia(self, mock_client):
        ...
        from src.services.batch_cooking import BatchCookingService, EtapeBatchIA, SessionBatchIA
        ...
        mock_session = SessionBatchIA(
            ...
            etapes=[EtapeBatchIA(ordre=1, titre="Prep", description="PrÃ©parer", duree_minutes=15)],
        )

        service = BatchCookingService()
        service.generer_plan_ia = Mock(return_value=mock_session)

        result = service.generer_plan_ia(recettes=["Poulet"], robots=["four"], duree_max=180)
    ...
    def test_suggerer_recettes_batch(self, mock_client):
        ...
        mock_suggestions = [{"nom": "Poulet", "portions": 4}, {"nom": "LÃ©gumes", "portions": 6}]
    ...
    def test_attribuer_preparations_planning(self, mock_client):
        ...
        result = service.attribuer_preparations_planning(planning_id=1, preparations_ids=[1, 2, 3])
...
class TestFactory:
    ...
    def test_get_batch_cooking_service(self, mock_client):
        ...
        from src.services.batch_cooking import BatchCookingService, get_batch_cooking_service
...
class TestEdgeCases:
    ...
    def test_etape_long_title(self):
        ...
        long_title = "A" * 200
        etape = EtapeBatchIA(ordre=1, titre=long_title, description="Description", duree_minutes=10)
    ...
    def test_preparation_long_name(self):
        ...
        prep = PreparationIA(nom=long_name, portions=4, conservation_jours=7)
    ...
    def test_session_many_recipes(self):
        ...
        session = SessionBatchIA(recettes=recipes, duree_totale_estimee=300, etapes=[etape])
...
class TestBatchCookingIntegration:
    ...
    def test_creer_session_empty_recettes(self, mock_client, patch_db_context):
        ...
        with pytest.raises(ErreurValidation):
            service.creer_session(date_session=date.today() + timedelta(days=1), recettes_ids=[])
    ...
    def test_attribuer_preparations_planning_not_found(self, mock_client, patch_db_context):
        ...
        service = BatchCookingService()
        result = service.attribuer_preparations_planning(planning_id=9999, preparations_ids=[1, 2])
...
class TestBatchCookingWorkflow:
    ...
    def test_creer_preparation_integration(self, mock_client, patch_db_context):
        ...
        service = BatchCookingService()
        result = service.creer_preparation(nom="Sauce test", portions=4, conservation_jours=7)
    ...
    def test_get_sessions_planifiees_with_dates(self, mock_client, patch_db_context):
        ...
        service = BatchCookingService()
        result = service.get_sessions_planifiees(
            date_debut=date.today(), date_fin=date.today() + timedelta(days=14)
        )
...
class TestGenererPlanIAIntegration:
    ...
    def test_suggerer_recettes_batch_with_options(self, mock_client, patch_db_context):
        ...
        result = service.suggerer_recettes_batch(
            nb_recettes=4, avec_jules=True, robots_disponibles=["four", "cookeo"]
        )
