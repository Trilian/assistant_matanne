...
class TestJourCompletSchema:
    ...
    def test_jour_complet_schema_minimal(self):
        ...
        jour = JourCompletSchema(date=date(2026, 2, 7), charge="normal", charge_score=50)
    ...
    def test_jour_complet_schema_charge_faible(self):
        ...
        jour = JourCompletSchema(date=date(2026, 2, 8), charge="faible", charge_score=20)
...
class TestSemaineCompleSchema:
    ...
    def test_semaine_complete_schema_minimal(self):
        ...
        from src.services.planning_unified import JourCompletSchema, SemaineCompleSchema

        jours = {}
        for i in range(7):
            jour_date = date(2026, 2, 2) + timedelta(days=i)
            jours[jour_date.isoformat()] = JourCompletSchema(
                date=jour_date, charge="normal", charge_score=40
            )
...
class TestSemaineGenereeIASchema:
    ...
    def test_semaine_generee_ia_schema_full(self):
        ...
        semaine = SemaineGenereeIASchema(
            repas_proposes=[{"jour": "Lundi", "dejeuner": "P̢tes", "diner": "Soupe"}],
            activites_proposees=[{"jour": "Mardi", "activite": "Parc", "pour_jules": True}],
            projets_suggeres=[{"projet": "Rangement cuisine", "priorite": "haute"}],
...
class TestPlanningAIServiceCalculerCharge:
    ...
    def test_calculer_charge_with_repas(self):
        ...
        repas = [{"id": 1, "temps_total": 60}, {"id": 2, "temps_total": 45}]

        score = service._calculer_charge(repas=repas, activites=[], projets=[], routines=[])
    ...
    def test_calculer_charge_with_activites(self):
        ...
        activites = [{"id": 1, "titre": "Activite 1"}, {"id": 2, "titre": "Activite 2"}]

        score = service._calculer_charge(repas=[], activites=activites, projets=[], routines=[])
    ...
    def test_calculer_charge_with_projets_urgents(self):
        ...
        score = service._calculer_charge(repas=[], activites=[], projets=projets, routines=[])
    ...
    def test_calculer_charge_with_routines(self):
        ...
        score = service._calculer_charge(repas=[], activites=[], projets=[], routines=routines)
    ...
    def test_calculer_charge_max_100(self):
        ...
        score = service._calculer_charge(
            repas=repas, activites=activites, projets=projets, routines=routines
        )
...
class TestPlanningAIServiceDetecterAlertes:
    ...
    def test_detecter_alertes_surcharge(self):
        ...
        alertes = service._detecter_alertes(
            jour=date(2026, 2, 7), repas=[], activites=[], projets=[], charge_score=85
        )
    ...
    def test_detecter_alertes_pas_activite_jules(self):
        ...
        activites = [{"id": 1, "titre": "Sortie adultes", "pour_jules": False}]

        alertes = service._detecter_alertes(
            jour=date(2026, 2, 7), repas=[], activites=activites, projets=[], charge_score=50
        )
    ...
    def test_detecter_alertes_projets_urgents(self):
        ...
        projets = [{"id": 1, "priorite": "haute"}, {"id": 2, "priorite": "haute"}]

        alertes = service._detecter_alertes(
            jour=date(2026, 2, 7), repas=[], activites=[], projets=projets, charge_score=50
        )
    ...
    def test_detecter_alertes_trop_repas(self):
        ...
        alertes = service._detecter_alertes(
            jour=date(2026, 2, 7), repas=repas, activites=[], projets=[], charge_score=50
        )
...
class TestPlanningAIServiceDetecterAlertesSemaine:
    ...
    def test_detecter_alertes_semaine_no_jules(self):
        ...
        from src.services.planning_unified import JourCompletSchema, PlanningAIService
...
class TestPlanningAIServiceCalculerBudgetJour:
    ...
    def test_calculer_budget_jour_with_budget(self):
        ...
        activites = [{"id": 1, "budget": 25.0}, {"id": 2, "budget": 15.0}]
...
class TestPlanningAIServiceCalculerStatsSemaine:
    ...
    def test_calculer_stats_semaine_empty(self):
        ...
        for i in range(7):
            jour_date = date(2026, 2, 2) + timedelta(days=i)
            jours[jour_date.isoformat()] = JourCompletSchema(
                date=jour_date, charge="faible", charge_score=10
            )
...
class TestPlanningAIServiceGenererSemaineIA:
    ...
    def test_generer_semaine_ia_failure(self):
        ...
        with patch.object(service, "call_with_list_parsing_sync", return_value=None):
            result = service.generer_semaine_ia(
                date_debut=date(2026, 2, 2), contraintes={}, contexte={}
            )
...
class TestPlanningAIServiceGetSemaineComplete:
    ...
    def test_get_semaine_complete_mock(self):
        ...
        with (
            patch.object(service, "_charger_repas", return_value={}),
    ...
    def test_get_semaine_complete_with_data(self):
        ...
        with (
            patch.object(service, "_charger_repas", return_value=repas_data),
