...
class TestBarcodeData:
    ...
    def test_creation_basique(self):
        ...
        data = BarcodeData(code="3017620422003", type_code="EAN-13")
...
class TestBarcodeArticle:
    ...
    def test_creation_basique(self):
        ...
        article = BarcodeArticle(
            barcode="3017620422003", article_id=1, nom_article="Nutella 500g", categorie="Ã‰picerie"
        )
...
class TestBarcodeRecette:
    ...
    def test_creation_basique(self):
        ...
        recette = BarcodeRecette(
            barcode="RECETTE00001", recette_id=42, nom_recette="Tarte aux pommes"
        )
...
class TestScanResultat:
    ...
    def test_creation_article(self):
        ...
        result = ScanResultat(
            barcode="3017620422003", type_scan="article", details={"id": 1, "nom": "Nutella"}
        )
    ...
    def test_creation_recette(self):
        ...
        result = ScanResultat(
            barcode="RECETTE00001", type_scan="recette", details={"id": 42, "nom": "Tarte"}
        )
    ...
    def test_creation_inconnu(self):
        ...
        result = ScanResultat(
            barcode="9999999999999", type_scan="inconnu", details={"message": "Code non reconnu"}
        )
...
class TestBarcodeIntegration:
    ...
    def test_workflow_scan_article(self):
        from src.services.barcode import BarcodeArticle, BarcodeService
...
class TestBarcodeImports:
    ...
    def test_import_decorators(self):
        from src.core.decorators import with_cache, with_db_session, with_error_handling
