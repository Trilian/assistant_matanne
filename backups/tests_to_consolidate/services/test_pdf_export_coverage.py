...
class TestRecettePDFDataModel:
    ...
    def test_recette_pdf_data_minimal(self):
        ...
        data = RecettePDFData(
            id=1, nom="Tarte aux pommes", ingredients=[{"nom": "Pomme", "quantite": "4"}]
        )
...
class TestPlanningPDFDataModel:
    ...
    def test_planning_pdf_data_minimal(self):
        ...
        data = PlanningPDFData(semaine_debut=debut, semaine_fin=fin)
...
class TestGenererPdfRecette:
    ...
    def test_generer_pdf_recette_minimal(self):
        ...
        data = RecettePDFData(
            id=1, nom="Omelette", ingredients=[{"nom": "Oeufs", "quantite": 3, "unite": "pcs"}]
        )
...
class TestGenererPdfCourses:
    ...
    def test_generer_pdf_courses_vide(self):
        ...
        from src.services.pdf_export import CoursesPDFData, PDFExportService

        service = PDFExportService()

        data = CoursesPDFData(articles=[], total_articles=0, par_categorie={})
    ...
    def test_generer_pdf_courses_avec_articles(self):
        ...
        data = CoursesPDFData(
            ...
            par_categorie={
                ...
                "viande": [{"nom": "Poulet", "quantite": 1, "unite": "kg", "urgent": True}],
            },
        )
    ...
    def test_generer_pdf_courses_toutes_categories(self):
        ...
        for cat in categories_test:
            par_categorie[cat] = [
                {"nom": f"Article {cat}", "quantite": 1, "unite": "pcs", "urgent": False}
            ]

        data = CoursesPDFData(
            articles=[
                {"nom": f"Art {cat}", "quantite": 1, "categorie": cat} for cat in categories_test
            ],
    ...
    def test_generer_pdf_courses_articles_urgents(self):
        ...
        data = CoursesPDFData(
            ...
            total_articles=1,
            par_categorie={
                "produits_laitiers": [{"nom": "Lait", "quantite": 2, "unite": "L", "urgent": True}]
            },
        )
    ...
    def test_generer_pdf_courses_quantite_zero(self):
        ...
        data = CoursesPDFData(
            ...
            total_articles=1,
            par_categorie={
                "epicerie": [{"nom": "Sel", "quantite": 0, "unite": "", "urgent": False}]
            },
        )
...
class TestEdgeCases:
    ...
    def test_pdf_planning_jours_partiels(self):
        ...
        data = PlanningPDFData(
            semaine_debut=datetime.now(),
            semaine_fin=datetime.now() + timedelta(days=6),
            repas_par_jour={"Mercredi": [{"type": "d̩jeuner", "recette": "Pasta", "notes": ""}]},
            total_repas=1,
        )
    ...
    def test_pdf_courses_categorie_inconnue(self):
        ...
        data = CoursesPDFData(
            articles=[
                {"nom": "Article myst̬re", "quantite": 1, "categorie": "categorie_inconnue"}
            ],
            total_articles=1,
            par_categorie={
                "categorie_inconnue": [
                    {"nom": "Article myst̬re", "quantite": 1, "unite": "", "urgent": False}
                ]
            },
        )
    ...
    def test_pdf_planning_nom_vide(self):
        ...
        data = PlanningPDFData(
            semaine_debut=datetime.now(), semaine_fin=datetime.now() + timedelta(days=6)
        )
