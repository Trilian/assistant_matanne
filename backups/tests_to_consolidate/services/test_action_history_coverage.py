...
class TestLogAction:
    ...
    @patch.object(
        __import__(
            "src.services.action_history", fromlist=["ActionHistoryService"]
...
class TestLogSpecializedMethods:
    ...
    def test_log_recette_updated(self, mock_user, mock_save):
        ...
        entry = service.log_recette_updated(
            1, "Tarte", old_data={"nom": "Tarte"}, new_data={"nom": "Tarte aux pommes"}
        )
...
class TestGetHistory:
    ...
    def test_get_history_fallback_to_cache(self):
        ...
        from src.services.action_history import ActionEntry, ActionHistoryService, ActionType
...
class TestGetHistoryDB:
    ...
    def test_get_history_with_filters_returns_list(self):
        ...
        from src.services.action_history import ActionFilter, ActionHistoryService

        service = ActionHistoryService()

        # Test avec filtres basiques - retourne cache vide ou liste
        filters = ActionFilter(user_id="user1", limit=10)
...
class TestRenderActivityTimeline:
    ...
    def test_render_timeline_with_actions(self):
        ...
        from src.services.action_history import ActionEntry, ActionType, render_activity_timeline
...
class TestRenderUserActivity:
    ...
    def test_render_user_activity_with_actions(self):
        ...
        from src.services.action_history import ActionEntry, ActionType, render_user_activity
...
class TestRenderActivityStats:
    ...
    def test_render_activity_stats(self):
        ...
        from src.services.action_history import ActionStats, render_activity_stats
