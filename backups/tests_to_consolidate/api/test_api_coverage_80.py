...
class TestRateLimitConfig:
    ...
    def test_custom_values(self):
        ...
        config = RateLimitConfig(
            requests_per_minute=100, requests_per_hour=2000, enable_headers=False
        )
...
class TestRateLimiter:
    ...
    def test_add_headers(self):
        from src.api.rate_limiting import RateLimitConfig, RateLimiter
...
class TestRateLimitingUtils:
    ...
    def test_configure_rate_limits(self):
        from src.api.rate_limiting import RateLimitConfig, configure_rate_limits
...
class TestRecetteSchemas:
    ...
    def test_recette_response(self):
        ...
        recette = RecetteResponse(
            id=1, nom="Test", created_at=datetime.now(), updated_at=datetime.now()
        )
        assert recette.id == 1
...
class TestInventaireSchemas:
    ...
    def test_inventaire_item_create(self):
        ...
        item = InventaireItemCreate(
            nom="Lait", quantite=2, code_barres="1234567890", emplacement="Frigo"
        )
...
class TestOtherSchemas:
    ...
    def test_paginated_response(self):
        ...
        resp = PaginatedResponse(items=[{"id": 1}], total=100, page=1, page_size=20, pages=5)
    ...
    def test_health_response(self):
        ...
        resp = HealthResponse(
            status="healthy", version="1.0.0", database="ok", timestamp=datetime.now()
        )
...
class TestRateLimitMiddleware:
    ...
    def test_middleware_custom_limiter(self):
        from src.api.rate_limiting import RateLimiter, RateLimitMiddleware
...
class TestPlanningSchemas:
    ...
    def test_planning_base(self):
        ...
        planning = PlanningBase(nom="Planning Semaine", date_debut=datetime.now())
    ...
    def test_planning_with_end_date(self):
        ...
        planning = PlanningBase(nom="Planning", date_debut=start, date_fin=end)
...
class TestRepasSchemas:
    ...
    def test_repas_base_valid(self):
        ...
        repas = RepasBase(type_repas="dÃ©jeuner", date=datetime.now(), notes="Repas familial")
    ...
    def test_repas_base_invalid_type(self):
        ...
        with pytest.raises(ValidationError):
            RepasBase(type_repas="invalid_type", date=datetime.now())

    def test_repas_create(self):
        from src.api.main import RepasCreate

        repas = RepasCreate(type_repas="dÃ®ner", date=datetime.now(), recette_id=1)
...
class TestCourseSchemasExtra:
    ...
    def test_liste_courses_response(self):
        from src.api.main import CourseItemBase, ListeCoursesResponse

        item = CourseItemBase(nom="Pommes", quantite=2)
        response = ListeCoursesResponse(
            id=1, nom="Liste de la semaine", items=[item], created_at=datetime.now()
        )
...
class TestInventaireExtraSchemas:
    ...
    def test_inventaire_item_response(self):
        ...
        response = InventaireItemResponse(
            id=1, nom="Lait", quantite=2, code_barres="123", created_at=datetime.now()
        )
...
class TestCRUDEndpoints:
    ...
    def test_create_recette_endpoint(self):
        ...
        response = client.post(
            "/api/v1/recettes",
            json={"nom": "Nouvelle recette", "description": "Description", "temps_preparation": 30},
        )
    ...
    def test_update_recette_endpoint(self):
        ...
        response = client.put(
            "/api/v1/recettes/1",
            json={"nom": "Recette modifiÃ©e", "description": "Nouvelle description"},
        )
...
class TestInventaireCRUD:
    ...
    def test_create_inventaire_item(self):
        ...
        response = client.post(
            "/api/v1/inventaire", json={"nom": "Lait", "quantite": 2, "unite": "L"}
        )
...
class TestCoursesCRUD:
    ...
    def test_create_course_list(self):
        ...
        client = TestClient(main_module.app)
        response = client.post("/api/v1/courses", json={"nom": "Ma liste"})
    ...
    def test_add_course_item(self):
        ...
        client = TestClient(main_module.app)
        response = client.post("/api/v1/courses/1/items", json={"nom": "Pommes", "quantite": 3})
...
class TestPlanningCRUD:
    ...
    def test_create_repas(self):
        ...
        response = client.post(
            ...
            json={"type_repas": "dÃ©jeuner", "date": datetime.now().isoformat()},
        )
...
class TestRateLimitMiddlewareConfig:
    ...
    def test_middleware_custom_config(self):
        ...
        config = rl_module.RateLimitConfig(requests_per_minute=30, enable_headers=False)
        limiter = rl_module.RateLimiter(config=config)
...
class TestTokenAuth:
    ...
    def test_endpoint_with_invalid_token(self):
        ...
        client = TestClient(main_module.app, raise_server_exceptions=False)
        response = client.get(
            "/api/v1/recettes", headers={"Authorization": "Bearer invalid_token_here"}
        )
    ...
    def test_endpoint_with_malformed_token(self):
        ...
        client = TestClient(main_module.app, raise_server_exceptions=False)
        response = client.get("/api/v1/health", headers={"Authorization": "Bearer "})
    ...
    def test_endpoint_with_bearer_only(self):
        ...
        client = TestClient(main_module.app, raise_server_exceptions=False)
        response = client.get("/api/v1/health", headers={"Authorization": "NotBearer token"})
...
class TestMorePydanticValidation:
    ...
    def test_recette_base_empty_nom(self):
        ...
        try:
            r = RecetteBase(nom="A", description="Desc")
            assert r.nom == "A"
        except Exception:
    ...
    def test_recette_base_long_description(self):
        ...
        long_desc = "x" * 1000
        r = RecetteBase(nom="Test Long Desc", description=long_desc)
    ...
    def test_inventaire_special_characters(self):
        ...
        item = InventaireItemBase(nom="Item Ã©Ã Ã¼", quantite=1.5, unite="piÃ¨ce(s)")
    ...
    def test_course_item_unicode(self):
        ...
        item = CourseItemBase(nom="ðŸŽ Pommes", quantite=3, coche=False)
    ...
    def test_repas_base_all_fields(self):
        ...
        repas = RepasBase(
            type_repas="dÃ®ner", date="2024-01-15", recette_id=123, notes="Notes du repas"
        )
...
class TestRateLimitingEdgeCases:
    ...
    def test_rate_limit_config_high_values(self):
        ...
        config = rl_module.RateLimitConfig(requests_per_minute=10000, requests_per_hour=100000)
...
class TestRateLimitStrategies:
    ...
    def test_fixed_window_strategy(self):
        ...
        config = rl_module.RateLimitConfig(strategy=rl_module.RateLimitStrategy.FIXED_WINDOW)
    ...
    def test_sliding_window_strategy(self):
        ...
        config = rl_module.RateLimitConfig(strategy=rl_module.RateLimitStrategy.SLIDING_WINDOW)
    ...
    def test_token_bucket_strategy(self):
        ...
        config = rl_module.RateLimitConfig(strategy=rl_module.RateLimitStrategy.TOKEN_BUCKET)
...
class TestExemptPaths:
    ...
    def test_custom_exempt_paths(self):
        ...
        config = rl_module.RateLimitConfig(exempt_paths=["/custom", "/another"])
...
class TestDatabaseIndependentSchemas:
    ...
    def test_inventaire_update_model(self):
        ...
        item = InventaireItemBase(nom="Lait", quantite=2.0, unite="L", date_peremption="2024-02-15")
...
class TestAPIRouteVariations:
    ...
    def test_put_recette_nonexistent(self):
        ...
        client = TestClient(main_module.app, raise_server_exceptions=False)
        response = client.put("/api/v1/recettes/9999", json={"nom": "Updated"})
