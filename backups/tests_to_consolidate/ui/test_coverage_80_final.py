...
class TestFormBuilderValidation:
    ...
    def test_validate_success(self):
        ...
        form = FormBuilder("test")
        form.fields = [{"name": "nom", "required": True}, {"name": "opt", "required": False}]
...
class TestIOConfig:
    ...
    def test_io_config_init(self):
        ...
        config = IOConfig(field_mapping={"nom": "Nom", "qty": "Quantit̩"}, required_fields=["nom"])
    ...
    def test_io_config_with_transformers(self):
        ...
        config = IOConfig(
            field_mapping={"nom": "Nom"}, required_fields=["nom"], transformers={"nom": str.upper}
        )
...
class TestSidebar:
    ...
    def test_afficher_sidebar(self, mock_st, mock_get_etat, mock_gest, mock_stats):
        ...
        mock_get_etat.return_value = MagicMock(module_actuel="accueil", mode_debug=False)
...
class TestTabsLayoutContent:
    ...
    def test_tabs_layout_calls_content(self, mock_st):
        ...
        content_called = []
        tab_data = {"Tab 1": lambda: content_called.append(1)}
