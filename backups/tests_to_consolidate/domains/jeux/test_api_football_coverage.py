...
def mock_teams_fallback_response():
    ...
    return {"teams": [{"name": "Ã‰quipe A"}, {"name": "Ã‰quipe B"}, {"name": "Ã‰quipe C"}]}
...
class TestChargerHistoriqueEquipe:
    ...
    def test_charger_historique_ok(self, mock_api_key):
        ...
        with patch(
            "src.modules.jeux.logic.api_football.faire_requete", side_effect=mock_faire_requete
        ):
...
class TestChercherEquipe:
    ...
    def test_chercher_equipe_ok(self, mock_api_key, mock_team_response):
        ...
        with patch(
            "src.modules.jeux.logic.api_football.faire_requete", return_value=mock_team_response
        ):
