...
def matchs_5_victoires():
    ...
    return [
        ...
        {
            "equipe_domicile_id": 1,
            "equipe_exterieur_id": 5,
            "score_domicile": 1,
            "score_exterieur": 0,
        },
        {
            "equipe_domicile_id": 6,
            "equipe_exterieur_id": 1,
            "score_domicile": 0,
            "score_exterieur": 2,
        },
...
def matchs_mixtes():
    ...
    return [
        ...
        {
            "equipe_domicile_id": 1,
            "equipe_exterieur_id": 4,
            "score_domicile": 0,
            "score_exterieur": 2,
        },  # D
        {
            "equipe_domicile_id": 5,
            "equipe_exterieur_id": 1,
            "score_domicile": 1,
            "score_exterieur": 3,
        },  # V
...
class TestPredireResultatMatch:
    ...
    def test_prediction_forme_bonne_vs_mauvaise(
        self, forme_bonne, forme_mauvaise, h2h_avantage_domicile
    ):
    ...
    def test_prediction_forme_mauvaise_vs_bonne(
        self, forme_bonne, forme_mauvaise, h2h_avantage_domicile
    ):
    ...
    def test_prediction_avec_cotes(
        self, forme_bonne, forme_mauvaise, h2h_avantage_domicile, cotes_standard
    ):
        """Les cotes influencent la pr̩diction."""
        result = predire_resultat_match(
            forme_bonne, forme_mauvaise, h2h_avantage_domicile, cotes=cotes_standard
        )
...
class TestGenererAnalyseComplete:
    ...
    def test_analyse_complete_structure(self, forme_bonne, forme_mauvaise, h2h_avantage_domicile):
        ...
        result = generer_analyse_complete(
            forme_dom=forme_bonne, forme_ext=forme_mauvaise, h2h=h2h_avantage_domicile
        )
    ...
    def test_analyse_complete_avec_cotes(
        self, forme_bonne, forme_mauvaise, h2h_avantage_domicile, cotes_standard
    ):
