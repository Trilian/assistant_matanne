...
def mock_api_response():
    ...
    return {
        "results": [
            ...
            {"date": "2025-02-08", "numeros": [1, 18, 27, 38, 49], "numero_chance": 3},
        ]
    }
...
class TestObtenirTirageDuJour:
    ...
    def test_tirage_du_jour_nexiste_pas(self, scraper):
        ...
        mock_tirages = [{"date": "2025-02-01", "numeros": [1, 2, 3, 4, 5]}]
...
class TestInterfaceSimple:
    ...
    def test_charger_tirages_loto(self):
        ...
        with patch(
            "src.modules.jeux.logic.scraper_loto.ScraperLotoFDJ.charger_derniers_tirages"
        ) as mock:
    ...
    def test_obtenir_dernier_tirage_loto(self):
        ...
        with patch(
            "src.modules.jeux.logic.scraper_loto.ScraperLotoFDJ.obtenir_dernier_tirage",
            return_value=tirage_mock,
        ):
