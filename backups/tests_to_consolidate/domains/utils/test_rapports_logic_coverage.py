...
class TestGenererRapportSynthese:
    ...
    def test_statistiques_comptees(self):
        ...
        data = {"recettes": [1, 2, 3], "courses": [1, 2], "activites": [1], "inventaire": []}
...
class TestCalculerStatistiquesPeriode:
    ...
    def test_items_dans_periode(self):
        ...
        result = calculer_statistiques_periode(items, date(2024, 1, 15), date(2024, 1, 16))
    ...
    def test_items_hors_periode(self):
        ...
        result = calculer_statistiques_periode(items, date(2024, 1, 14), date(2024, 1, 16))
...
class TestGenererSectionRecettes:
    ...
    def test_compte_total(self):
        ...
        recettes = [{"nom": "PÃ¢tes"}, {"nom": "Riz"}, {"nom": "Salade"}]
...
class TestComparerPeriodes:
    ...
    def test_compare_toutes_categories(self):
        ...
        periode1 = {"recettes": [1, 2], "courses": [1], "activites": [1, 2, 3]}
        periode2 = {"recettes": [1, 2, 3], "courses": [1, 2], "activites": [1]}
...
class TestFormaterRapportTexte:
    ...
    def rapport_test(self):
        ...
        return {
            ...
            "statistiques": {"recettes": 30, "courses": 15},
            "sections": [{"titre": "ðŸ“… Recettes", "total": 30}],
        }
    ...
    def test_rapport_sans_sections(self):
        ...
        rapport = {"titre": "Test", "statistiques": {}}
...
class TestFormaterRapportMarkdown:
    ...
    def rapport_test(self):
        ...
        return {
            ...
            "statistiques": {"recettes": 14, "activites": 5},
            "sections": [
...
class TestFormaterRapportHtml:
    ...
    def rapport_test(self):
        ...
        return {
            ...
            "date_fin": date(2024, 1, 31),
            "date_generation": date(2024, 2, 1),
            "statistiques": {"recettes": 30},
            "sections": [{"titre": "Section 1", "total": 10}],
        }
    ...
    def test_rapport_sans_sections(self):
        """Rapport sans sections."""
        rapport = {"titre": "Test", "statistiques": {"total": 0}}
