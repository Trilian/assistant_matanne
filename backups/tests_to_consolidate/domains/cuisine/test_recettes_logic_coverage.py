...
class TestGetToutesRecettes:
    ...
    @patch("src.modules.cuisine.logic.recettes_logic.get_recette_service")
...
class TestGetRecettesFavorites:
    ...
    @patch("src.modules.cuisine.logic.recettes_logic.Recette")
    @patch("src.modules.cuisine.logic.recettes_logic.get_db_context")
...
class TestAjouterRepasPlanning:
    ...
    @patch("src.modules.cuisine.logic.recettes_logic.Repas")
    @patch("src.modules.cuisine.logic.recettes_logic.get_db_context")
