...
class TestIdentifierMomentsJules:
    ...
    def test_activite_melanger_securisee(self):
        ...
        etapes = [
            {
                "titre": "M̩langer la p̢te",
                "description": "M̩langer les ingr̩dients",
                "alerte_bruit": False,
            }
        ]
    ...
    def test_activite_verser_securisee(self):
        ...
        etapes = [{"titre": "Verser la farine", "description": "", "alerte_bruit": False}]
    ...
    def test_activite_observer(self):
        ...
        etapes = [
            {
                "titre": "Observer la cuisson",
                "description": "Regarder le g̢teau lever",
                "alerte_bruit": False,
            }
        ]
    ...
    def test_exclusion_si_bruyant(self):
        ...
        etapes = [{"titre": "M̩langer au robot", "description": "", "alerte_bruit": True}]
...
class TestGenererPlanningJules:
    ...
    def test_planning_liste_vide(self):
        ...
        planning = generer_planning_jules(etapes=[], heure_debut=time(10, 0))
...
class TestCalculerStatistiquesSession:
    ...
    def test_session_vide(self):
        ...
        session_data = {"etapes": [], "preparations": []}
...
class TestCalculerHistoriqueBatch:
    ...
    def test_historique_une_session(self):
        ...
        sessions = [{"duree_reelle": 90, "nb_portions_preparees": 6, "robots_utilises": ["cookeo"]}]
