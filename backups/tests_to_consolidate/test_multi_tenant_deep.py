...
class TestUserContextManager:
    ...
    def test_user_context_basic(self):
        ...
        from src.core.multi_tenant import ContexteUtilisateur, user_context
...
class TestAdminContext:
    ...
    def test_admin_context_enables_bypass(self):
        ...
        from src.core.multi_tenant import ContexteUtilisateur, admin_context
...
class TestWithUserIsolationDecorator:
    ...
    def test_with_user_isolation_injects_user_id(self):
        ...
        from src.core.multi_tenant import ContexteUtilisateur, avec_isolation_utilisateur
...
class TestRequireUserDecorator:
    ...
    def test_require_user_with_user(self):
        ...
        from src.core.multi_tenant import ContexteUtilisateur, exiger_utilisateur
...
class TestMultiTenantQuery:
    ...
    def test_filter_by_user(self):
        ...
        from src.core.multi_tenant import ContexteUtilisateur, RequeteMultiLocataire
    ...
    def test_filter_by_user_explicit_user_id(self):
        ...
        from src.core.multi_tenant import RequeteMultiLocataire
...
class TestMultiTenantService:
    ...
    def test_apply_user_filter(self, mock_model, mock_db):
        ...
        from src.core.multi_tenant import ContexteUtilisateur, ServiceMultiLocataire
...
class TestSetUserFromAuth:
    ...
    def test_set_user_from_auth_with_id(self):
        ...
        from src.core.multi_tenant import ContexteUtilisateur, definir_utilisateur_from_auth
...
class TestCreateMultiTenantService:
    ...
    def test_create_service(self):
        ...
        from src.core.multi_tenant import ServiceMultiLocataire, creer_multi_tenant_service
