...
class TestRedisConfig:
    ...
    def test_config_default_values(self):
        """Test des valeurs par d̩faut de configuration"""
...
class TestMemoryCache:
    ...
    def test_memory_cache_expired_entry(self):
        """Test entr̩e expir̩e"""
        from src.core.redis_cache import CacheMemoire

        cache = CacheMemoire()

        # Simuler une entr̩e expir̩e en modifiant directement le cache
    ...
    def test_memory_cache_invalidate_tag_returns_count(self):
        """Test que invalidate_tag retourne le nombre de cl̩s supprim̩es"""
        from src.core.redis_cache import CacheMemoire
...
class TestRedisCacheOperations:
    """Tests pour les op̩rations du cache Redis"""
    ...
    def test_make_key(self):
        """Test cr̩ation de cl̩ avec pr̩fixe"""
...
class TestRedisCacheSerialization:
    """Tests pour la s̩rialisation/d̩s̩rialisation"""
    ...
    def test_serialize_json_list(self):
        """Test s̩rialisation liste JSON"""
        data = [1, 2, 3, "test"]
    ...
    def test_serialize_pickle_fallback(self):
        """Test s̩rialisation pickle pour objets complexes"""
        # Cr̩er un objet non-JSON serializable
...
class TestRedisCachedDecorator:
    ...
    def test_redis_cached_basic(self):
        """Test d̩corateur basique"""
        from src.core.redis_cache import CacheRedis, redis_cached
        ...
        # Deuxi̬me ex̩cution (devrait ̻tre cach̩e)
        result2 = expensive_function(5)
        assert result2 == 10
        # Peut ̻tre 1 ou 2 selon l'impl̩mentation du cache
...
class TestRedisCacheTagInvalidation:
    ...
    def test_key_with_multiple_tags(self):
        """Test cl̩ avec plusieurs tags"""
        self.cache.set("item", "data", tags=["tag1", "tag2"])

        # Invalider un seul tag devrait supprimer la cl̩
...
class TestCacheDecorator:
    """Tests pour les d̩corateurs de cache si pr̩sents"""

    @patch("src.core.redis_cache.REDIS_DISPONIBLE", False)
    def test_cache_decorator_basic(self):
        """Test d̩corateur de cache basique"""
        from src.core.redis_cache import CacheRedis
        ...
        # Deuxi̬me ex̩cution depuis cache
        cached_result = cache.get(key)

        assert cached_result == 10
        assert call_count == 1  # Pas d'appel suppl̩mentaire
