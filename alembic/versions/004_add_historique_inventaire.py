...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_historique_inventaire_ingredient_id", "historique_inventaire", ["ingredient_id"]
    )
    op.create_index(
        "ix_historique_inventaire_type_modification", "historique_inventaire", ["type_modification"]
    )
    op.create_index(
        "ix_historique_inventaire_date_modification", "historique_inventaire", ["date_modification"]
    )
