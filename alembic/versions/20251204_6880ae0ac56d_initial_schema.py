...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "priority",
            sa.Enum("BASSE", "MOYENNE", "HAUTE", name="prioriteenum", native_enum=False),
            nullable=False,
        ),
        sa.Column(
            "status",
            sa.Enum(
                "A_FAIRE", "EN_COURS", "TERMINE", "ANNULE", name="statutenum", native_enum=False
            ),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "version_type",
            sa.Enum("CLASSIQUE", "BATCH_COOKING", "BEBE", name="versionrecetteenum"),
            nullable=True,
        ),
    ...
    op.create_table(
        ...
        sa.CheckConstraint(
            "type_version IN ('classique', 'batch_cooking', 'bébé')", name="check_version_type"
        ),
        sa.ForeignKeyConstraint(
            ["recette_base_id"],
            ["recettes.id"],
    ...
    op.create_table(
        ...
        sa.Column(
            "mood",
            sa.Enum("BIEN", "MOYEN", "MAL", name="humeurenum", native_enum=False),
            nullable=False,
        ),
