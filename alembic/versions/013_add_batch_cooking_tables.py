...
def upgrade():
    ...
    op.create_index("idx_session_date_statut", "sessions_batch_cooking", ["date_session", "statut"])
    ...
    op.create_index("idx_etape_session_ordre", "etapes_batch_cooking", ["session_id", "ordre"])
    ...
    op.create_index(
        "idx_prep_consomme_peremption", "preparations_batch", ["consomme", "date_peremption"]
    )
