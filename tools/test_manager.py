...
def show_stats():
    ...
    print("ðŸ“ Fichiers de test par catÃ©gorie:")
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Gestionnaire de tests pour Assistant Matanne")
    ...
    parser.add_argument(
        "-k", "--pattern", help="Pattern pour filtrer les tests (ex: 'test_recettes')"
    )
