...
BEGIN;
-- ----------------------------------------------------------------------------
-- Tables de migration (accès limité au service_role uniquement)
-- ----------------------------------------------------------------------------
ALTER TABLE IF EXISTS public.alembic_version ENABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS public.schema_migrations ENABLE ROW LEVEL SECURITY;
-- Politiques pour tables de migration (service_role uniquement)
DROP POLICY IF EXISTS "service_role_alembic_version" ON public.alembic_version;
CREATE POLICY "service_role_alembic_version" ON public.alembic_version FOR ALL TO service_role USING (true) WITH CHECK (true);
