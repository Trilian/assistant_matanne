...
Tape les premiers mots du module ou de la page (« rec », à planning », « jul ») et appuie sur `Entrée`.
...
- ?Les **repas planifiés** (liés au planning cuisine)
...
Pour une conversation plus longue, clique sur à Ouvrir le chat IA à en bas du popout.
...
2. Le contenu exploitable est analysé pour pré-remplir les champs
...
> **Note** : L'import fonctionne avec la plupart des sites de recettes français. Si un site ne fonctionne pas, signalez-le.
