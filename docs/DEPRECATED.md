...
| Fonctionnalité retirée | Statut | Remplacement | Raison |
| --- | --- | --- | --- |
| courbe de croissance Jules (poids, taille, périmètre, percentiles OMS) | retiré | jalons de développement, alimentation, activités, vaccins, rendez-vous | hors besoin produit, ne plus reproposer |
...
| intégration Vinted / annonces d'occasion | retiré | aucun | hors scope du hub familial privé et non prioritaire |
...
- pour Jules, conserver uniquement les axes utiles au quotidien : jalons, alimentation, activités, vaccins et rendez-vous
