...
# Look for: '💡' pattern which is 0xC3 0xB0 0xC2 0x9F when UTF-8 is mis-decoded as Latin-1
...
# Interpreted as Latin-1: 📅  which is C3 B0 C2 9F C2 93 C2 85

import struct

def find_mojibake_patterns(data, sample_count=10):
    """Find patterns of mojibake emoji bytes"""
    mojibake_marker = b'\xc3\xb0\xc2\x9f'  # 💡 prefix
...
replacements_hex = [
    ...
    (b'\xc3\xb0\xc2\x9f\xc2\x93\x9e', b'\xf0\x9f\x94\x84'),  # 🎯„ → 🔄
    (b'\xc3\xb0\xc2\x9f\xc2\x93\xa5', b'\xf0\x9f\x93\xa5'), # 🎯¥ → 📥
]
